...
const ROUTES = [
  ...
  ["/alice_fixture/with_replies", "profile"],
  ["/alice_fixture/media", "profile"],
  ["/alice_fixture/highlights", "profile"],
  ["/alice_fixture/articles", "profile"],
  ["/notifications", "notifications"],
  ["/messages", "messages"],
  ["/i/chat", "messages"],
  ["/i/chat/pin/recovery", "messages"],
