...
export const PANEL_CATALOG: Partial<Record<LocaleCode, Record<string, string>>> = {
  es: {
    ...
    "Language": "Idioma",
    "Theme": "Tema",
    "Noir adds Aviary's premium cyan-violet skin; Off leaves X's own styling untouched.": "Noir añade el aspecto premium cian y violeta de Aviary; Desactivado deja intacto el estilo de X.",
    ...
    "Master switch for the four numbers below. The controls still work and screen readers still announce the totals.": "Interruptor principal de los cuatro números siguientes. Los controles siguen funcionando y los lectores de pantalla siguen anunciando los totales.",
    "Hide reply counts": "Ocultar el número de respuestas",
    "Applies while Hide engagement counts is on.": "Se aplica mientras «Ocultar recuentos de interacción» está activo.",
    "Hide repost counts": "Ocultar el número de republicaciones",
    "Hide like counts": "Ocultar el número de me gusta",
    "Hide view counts": "Ocultar el número de visualizaciones",
    "Applies while Hide engagement counts is on. The view total lives in an analytics link, not an action button.": "Se aplica mientras «Ocultar recuentos de interacción» está activo. El total de visualizaciones está en un enlace de analíticas, no en un botón de acción.",
    "Hide the tab title badge": "Ocultar el contador en el título de la pestaña",
    "Remove X's unread count from the browser tab title, so a hidden notification badge is not restored by the tab.": "Elimina el contador de no leídos de X del título de la pestaña, para que la pestaña no devuelva un aviso que ya habías ocultado.",
    "Absolute timestamps": "Marcas de tiempo absolutas",
    "Show the exact date and time on every post instead of X's relative text.": "Muestra la fecha y la hora exactas en cada publicación en lugar del texto relativo de X.",
    "Use Aviary's tab icon": "Usar el icono de pestaña de Aviary",
    "Replace X's favicon with Aviary's mark so its tabs are easy to pick out. Restores X's own icon when off.": "Sustituye el favicon de X por la marca de Aviary para distinguir sus pestañas de un vistazo. Al desactivarlo se restaura el icono propio de X.",
    ...
    "Protection starts at document load.": "La protección comienza al cargar el documento.",
    "Ad-free mode": "Modo sin anuncios",
    "Collapse sponsored posts, paid partnerships, promoted trends, house promos, and visible pre-rolls. Aviary also refuses X's separate promoted-content logging call without blocking timeline delivery.": "Oculta publicaciones patrocinadas, colaboraciones pagadas, tendencias promocionadas, anuncios propios y pre-rolls visibles. Aviary también rechaza la llamada separada de registro de contenido promocionado de X sin bloquear la entrega del timeline.",
    "Refuse X's ad logging call": "Rechazar la llamada de registro de anuncios de X",
    "Only applies while Ad-free mode is on. Aviary refuses exactly one request — X's separate promoted-content logging call — and nothing else, including the checks X uses to notice an ad blocker. Turn this off if X complains anyway: sponsored posts stay hidden and Aviary stops refusing any request at all.": "Solo se aplica mientras el modo sin anuncios está activado. Aviary rechaza exactamente una petición — la llamada de registro de contenido promocionado de X — y ninguna otra, incluidas las comprobaciones que X usa para detectar un bloqueador de anuncios. Desactívalo si X se queja de todos modos: las publicaciones patrocinadas siguen ocultas y Aviary deja de rechazar cualquier petición.",
    "Ad protection status": "Estado de la protección contra anuncios",
    ...
    "Remove Who to follow cards without hiding the rest of the sidebar.": "Elimina las tarjetas «A quién seguir» sin ocultar el resto de la barra lateral.",
    "Hide home composer": "Ocultar el editor de Inicio",
    "Remove the quick-post composer from Home. The Post button still opens it when needed.": "Elimina el editor de publicación rápida de Inicio. El botón Publicar sigue abriéndolo cuando lo necesites.",
    "Hide thread recommendations": "Ocultar recomendaciones del hilo",
    "Stop a conversation at its last real reply by collapsing the Discover more block and the suggested posts below it.": "Termina la conversación en su última respuesta real contrayendo el bloque Descubre más y las publicaciones sugeridas debajo.",
    "Hide Grok surfaces": "Ocultar superficies de Grok",
    "Remove the Grok drawer, navigation link, image-generation entries, and per-post actions where detected.": "Elimina el panel y el enlace de navegación de Grok, sus entradas de generación de imágenes y las acciones por publicación.",
    "Focus mode": "Modo concentración",
    "Outside the hours below, cover the reading column with a calm local panel. Navigation stays usable and a five-minute override is one click away. Nothing is blocked and nothing leaves this device.": "Fuera del horario indicado abajo, cubre la columna de lectura con un panel local discreto. La navegación sigue disponible y una excepción de cinco minutos está a un clic. No se bloquea nada y nada sale de este dispositivo.",
    ...
    "Hide navigation items": "Ocultar elementos de navegación",
    "One stable X navigation id per line: home, explore, notifications, follow, chat, grok, history, studio, premium, profile, or more.": "Un ID estable de navegación de X por línea: home, explore, notifications, follow, chat, grok, history, studio, premium, profile o more.",
    "Ad protection": "Protección contra anuncios",
    "Page chrome": "Elementos de la página",
    "Reading flow": "Flujo de lectura",
    "Navigation": "Navegación",
    "Rules are active on the selected routes.": "Las reglas están activas en las rutas seleccionadas.",
    ...
    "Fade a post the second time it scrolls past, so a return trip down the timeline shows what is new. Hovering a faded post brings it back. Only post IDs are stored.": "Atenúa una publicación la segunda vez que pasa por pantalla, de modo que al recorrer de nuevo la cronología se vea lo nuevo. Al pasar el cursor sobre una publicación atenuada vuelve a su estado normal. Solo se guardan los ID de las publicaciones.",
    "Filter rules": "Reglas de filtrado",
    "One rule per line: field, optional not, operator, value. Fields are text, handle, media, verified, link; operators are contains, is, starts, ends, matches. Join with and / or, and prefix dim: to fade instead of hide. Example: dim: text contains sale and media is photo": "Una regla por línea: campo, «not» opcional, operador y valor. Los campos son text, handle, media, verified y link; los operadores son contains, is, starts, ends y matches. Únelos con «and» u «or», y antepón «dim:» para atenuar en lugar de ocultar. Ejemplo: dim: text contains sale and media is photo",
    ...
    "Activates when Hide dismissed posts is on.": "Se activa cuando Ocultar publicaciones descartadas está habilitado.",
    ...
    "Keep video playing when the tab loses focus": "Seguir reproduciendo el vídeo al cambiar de pestaña",
    "X stops a playing video when you switch tabs. This resumes it when you come back. A video you paused yourself stays paused.": "X detiene el vídeo en reproducción cuando cambias de pestaña. Esto lo reanuda al volver. Un vídeo que pausaste tú sigue en pausa.",
    "Loop videos": "Repetir los vídeos",
    "Restart a video when it reaches the end instead of stopping.": "Reinicia el vídeo al llegar al final en lugar de detenerlo.",
    "Pin video playlists to their best rendition": "Fijar las listas de reproducción a su mejor versión",
    "When X hands Aviary a playlist listing several qualities, keep only the highest. X often settles below the best available on a fast connection. This uses more data, and it can only act on playlists Aviary sees.": "Cuando X entrega a Aviary una lista con varias calidades, conserva solo la más alta. Con una conexión rápida, X suele quedarse por debajo de la mejor disponible. Consume más datos y solo puede actuar sobre las listas que Aviary ve.",
    ...
    "Add one Download action to each media post, plus per-asset controls.": "Añade una acción Descargar a cada publicación con contenido multimedia, además de controles por recurso.",
    ...
    "Maximum media downloads in flight during a batch (1-6).": "Máximo de descargas multimedia simultáneas durante un lote (1-6).",
    ...
    "Capture media bytes in export": "Capturar bytes multimedia en la exportación",
    "Fetch media during the export action and include successful bytes with length and checksum; failed items remain retryable references.": "Descarga el contenido multimedia durante la exportación e incluye los bytes obtenidos con longitud y suma de comprobación; los elementos fallidos quedan como referencias reintentables.",
    ...
    "{jobs} jobs tracked · {queries} GraphQL IDs cached": "{jobs} trabajos seguidos · {queries} IDs de GraphQL en caché",
    ...
    "Destination": "Destino",
    "Jobs": "Tareas",
    "Show the AI button on posts": "Mostrar el botón de IA en las publicaciones",
    "Adds a button to every post that builds a Translate, Summarize, Explain or Fact-check prompt. Without an AI provider configured it copies the prompt to your clipboard; nothing is sent anywhere.": "Añade a cada publicación un botón que crea una instrucción de Traducir, Resumir, Explicar o Verificar. Si no has configurado un proveedor de IA, copia la instrucción al portapapeles; no se envía nada a ninguna parte.",
    ...
    "Format: handle: colour. One per line. Colours are amber, rose, violet, sky, green, or slate. An empty line removes the tag.": "Formato: usuario: color. Uno por línea. Los colores son amber, rose, violet, sky, green o slate. Una línea vacía elimina la etiqueta.",
    ...
    "One snippet per line. Reusable replies / templates insert from the composer toolbar.": "Un fragmento por línea. Respuestas y plantillas reutilizables que se insertan desde la barra del compositor.",
    ...
    "{count} entries · latest {kind} of {latestCount} @ {at}": "{count} entradas · último {kind}: {latestCount} a las {at}",
    ...
    "Full-text search across the latest export collector run.": "Búsqueda de texto completo en la última ejecución del recolector de exportación.",
    "@handle, keyword, phrase…": "@usuario, palabra clave, frase…",
    "Type to search the records captured by export runs.": "Escribe para buscar los registros capturados por las ejecuciones de exportación.",
    ...
    "{total} items · queued {queued} · approved {approved} · skipped {skipped}": "{total} elementos · en cola {queued} · aprobados {approved} · omitidos {skipped}",
    ...
    "Live snapshots": "Instantáneas activas",
    ...
    "Split on blank lines and reply each segment to the previous one.": "Divide en párrafos vacíos y responde a cada segmento del anterior.",
    ...
    "AI data disclosure": "Divulgación de datos de IA",
    "Before sending, Aviary shows the provider, endpoint, fields, character/token estimate, retention, and budget status.": "Antes de enviar, Aviary muestra el proveedor, el endpoint, los campos, la estimación de caracteres/tokens, la retención y el estado del presupuesto.",
    "AI usage today": "Uso de IA hoy",
    "AI max request bytes": "Máximo de bytes por solicitud de IA",
    "Stop before sending one AI request larger than this UTF-8 body. Set 0 to block every AI request.": "Detén el envío de solicitudes de IA cuyo cuerpo UTF-8 supere este tamaño. Usa 0 para bloquear todas las solicitudes de IA.",
    "AI daily request bytes": "Bytes diarios de solicitudes de IA",
    "Stop AI provider calls after this many UTF-8 request bytes in the local day. Set 0 to block every AI request.": "Detén las llamadas al proveedor de IA tras estos bytes UTF-8 de solicitud en el día local. Usa 0 para bloquear todas las solicitudes de IA.",
    "Semantic search": "Búsqueda semántica",
    "Send captured record text to the configured embedding endpoint for similarity search. The destination, fields, retention, and byte budget are shown here.": "Envía el texto de los registros capturados al endpoint de embeddings configurado para buscar similitudes. Aquí se muestran el destino, los campos, la retención y el presupuesto de bytes.",
    ...
    "Embedding data disclosure": "Divulgación de datos de embeddings",
    "A request contains the model and captured record text. Vectors and bounded text stay in Aviary's local index; provider retention follows its policy.": "Una solicitud contiene el modelo y el texto del registro capturado. Los vectores y el texto limitado permanecen en el índice local de Aviary; la retención del proveedor sigue su política.",
    "Embedding usage today": "Uso de embeddings hoy",
    "Embedding max record bytes": "Máximo de bytes por registro de embedding",
    "Stop before sending one record larger than this UTF-8 body. Set 0 to block every embedding call.": "Detén el envío de registros cuyo cuerpo UTF-8 supere este tamaño. Usa 0 para bloquear todas las llamadas de incrustación.",
    "Embedding daily record bytes": "Bytes diarios de registros de embeddings",
    "Stop embedding calls after this many UTF-8 record bytes in the local day. Set 0 to block every embedding call.": "Detén las llamadas de incrustación tras estos bytes UTF-8 de registro en el día local. Usa 0 para bloquear todas las llamadas de incrustación.",
    "Auto-embed every export": "Incrustar automáticamente cada exportación",
    "Before enabling, review the endpoint, captured-record fields, local retention, and daily byte budget above. After each export, embed in the background. Off by default.": "Antes de activar, revisa arriba el endpoint, los campos de los registros capturados, la retención local y el presupuesto diario de bytes. Después de cada exportación, genera embeddings en segundo plano. Está desactivado de forma predeterminada.",
    ...
    "Forget local request counters only. This does not remove the semantic index or provider credentials.": "Olvida solo los contadores locales de solicitudes. No elimina el índice semántico ni las credenciales del proveedor.",
    "on": "activado",
    "off": "desactivado",
    ...
    "indexed": "indexados",
    "{name}: {state} · {config}": "{name} — {state} · {config}",
    "{name}: {state} · {count} {indexed}": "{name} — {state} · {count} {indexed}",
    "Integration status": "Estado de las integraciones",
    "Recent integration errors": "Errores recientes de integración",
    "Drawn from the audit log; only failed integration calls show up.": "Se muestran desde el registro de auditoría; solo aparecen las llamadas de integración fallidas.",
    "Connections": "Conexiones",
    "Intelligence": "Inteligencia",
    "Redacted — saved credentials will be kept.": "Redactadas: las credenciales guardadas se conservarán.",
    "Stop after the current collection and roll back anything already written.": "Detener después de la colección actual y revertir lo que ya se haya escrito.",
    ...
    "Credentials are redacted; the values already saved in this profile will be kept.": "Las credenciales están redactadas; se conservarán los valores ya guardados en este perfil.",
    "Reset all preferences": "Restablecer todas las preferencias",
    "Restores Aviary's defaults: ad-free mode stays on and every other visual or behavior control returns to off. Saved posts, notes, bookmarks, and download history are kept.": "Restaura los valores predeterminados de Aviary: el modo sin anuncios permanece activado y los demás controles visuales o de comportamiento vuelven a desactivarse. Se conservan las publicaciones, notas, marcadores y el historial de descargas.",
    ...
    "Select a JSON backup to inspect its versions, counts, conflicts, and checksum before changing local data.": "Selecciona una copia JSON para revisar sus versiones, cantidades, conflictos y suma de comprobación antes de cambiar los datos locales.",
    ...
    "Refuse X's analytics beacons": "Rechazar las balizas de analítica de X",
    "Stops the tracking pings X sends as you scroll, click and pause. Only the analytics endpoints are refused — timeline, media and login traffic is untouched.": "Detiene los avisos de seguimiento que X envía cuando te desplazas, haces clic o pausas. Solo se rechazan los puntos de analítica: el tráfico del cronograma, los medios y el inicio de sesión no se tocan.",
    "Monitor selector health": "Supervisar el estado de los selectores",
    "Check the current X surface for required and fallback anchors. Turn this off when you do not want selector diagnostics.": "Comprueba la superficie actual de X en busca de anclas obligatorias y alternativas. Desactívalo si no quieres diagnósticos de selectores.",
    "Connected to the page": "Conectado a la página",
    "Page access": "Acceso a la página",
    ...
    "Page hooks": "Integraciones de página",
    ...
    "Save or revert your changes before leaving this section.": "Guarda o revierte los cambios antes de salir de esta sección.",
    "Action failed.": "La acción falló.",
    "Saving...": "Guardando...",
    "Fix invalid values before saving.": "Corrige los valores no válidos antes de guardar.",
    "Local-only mode on": "Modo solo local activado",
    "Local-only mode off": "Modo solo local desactivado",
    "Analytics beacons refused": "Balizas de analítica rechazadas",
    "Analytics beacons allowed": "Balizas de analítica permitidas",
    "Selector health monitoring on": "Supervisión del estado de selectores activada",
    "Selector health monitoring off": "Supervisión del estado de selectores desactivada",
    ...
    "Assigned {moved} stores; {skipped} already existed.": "Se asignaron {moved} almacenes; {skipped} ya existían.",
    ...
    "Aria2 unreachable: {error}": "Aria2 no está disponible: {error}",
    "Aria2 connection test failed.": "Falló la prueba de conexión con Aria2.",
    "Cancelled {gid}.": "Se canceló {gid}.",
    "Aria2 cancel failed: {error}": "Falló la cancelación de Aria2: {error}",
    "Aria2 cancel failed.": "Falló la cancelación de Aria2.",
    ...
    "Bluesky failed: {error}": "Falló Bluesky: {error}",
    "Bluesky crosspost failed.": "Falló la publicación cruzada en Bluesky.",
    "Posted {posts} to Mastodon.{url}": "Se publicaron {posts} en Mastodon.{url}",
    "Mastodon failed: {error}": "Falló Mastodon: {error}",
    "Mastodon crosspost failed.": "Falló la publicación cruzada en Mastodon.",
    ...
    "Indexed: +{added} new · skipped {skipped} · errors {errors} · total {total}{trimmed}.": "Indexados: +{added} nuevos · omitidos {skipped} · errores {errors} · total {total}{trimmed}.",
    "Embedding failed.": "Fallaron los embeddings.",
    "Semantic index cleared": "Índice semántico borrado",
    "Could not clear semantic index.": "No se pudo borrar el índice semántico.",
    ...
    "Preferences reset. Ad-free mode is on.": "Preferencias restablecidas. El modo sin anuncios está activado.",
    ...
    "Import failed: {errors}": "Falló la importación: {errors}",
    ...
    "Cancelling restore…": "Cancelando la restauración…",
    "Dry-run complete. No local data changed.": "Simulación completada. No se cambiaron los datos locales.",
    "Dry-run failed: {errors}": "La simulación falló: {errors}",
    "Could not dry-run library restore.": "No se pudo simular la restauración de la biblioteca.",
    ...
    "Restore cancelled; local data was rolled back.": "Restauración cancelada; los datos locales se revirtieron.",
    "Restore cancelled.": "Restauración cancelada.",
    "Restore failed: {errors}": "La restauración falló: {errors}",
    ...
    "Archive import paused.": "Importación del archivo pausada.",
    "Archive import resumed.": "Importación del archivo reanudada.",
    "Archive import cancelled.": "Importación del archivo cancelada.",
    "Archive import retry started.": "Se inició el reintento de importación del archivo.",
    ...
    "Enqueued {added} items ({protected} protected skipped).": "Se añadieron {added} elementos ({protected} protegidos omitidos).",
    ...
    "Bookmark was already removed.": "El marcador ya se había eliminado.",
    ...
    "AI button on": "Botón de IA activado",
    "AI button off": "Botón de IA desactivado",
    ...
    "Export job paused.": "Trabajo de exportación pausado.",
    "Export job resumed.": "Trabajo de exportación reanudado.",
    "Export job cancelled.": "Trabajo de exportación cancelado.",
    ...
    "Exported {records} records across {files} ZIPs → {filename}": "Se exportaron {records} registros en {files} ZIP · {filename}",
    "Exported {records} record → {filename}": "Se exportó {records} registro · {filename}",
    "Exported {records} records → {filename}": "Se exportaron {records} registros · {filename}",
    ...
    "Copied {records} records to clipboard.": "Se copiaron {records} registros al portapapeles.",
    "Exported {records} records to {target}.": "Se exportaron {records} registros a {target}.",
    ...
    "Concurrent download limit saved": "Límite de descargas simultáneas guardado",
    ...
    "Tab title badge hidden": "Contador de la pestaña oculto",
    "Tab title badge shown": "Contador de la pestaña visible",
    ...
    "Aviary tab icon on": "Icono de pestaña de Aviary activado",
    "X tab icon restored": "Icono de pestaña de X restaurado",
    ...
    "Layout preference saved": "Preferencia de diseño guardada",
    "Grok preference saved": "Preferencia de Grok guardada",
    "Focus mode on": "Modo concentración activado",
    "Focus mode off": "Modo concentración desactivado",
    ...
    "Navigation visibility saved": "Visibilidad de navegación guardada",
    ...
    "Video keeps playing": "El vídeo sigue reproduciéndose",
    "Video pauses with the tab": "El vídeo se pausa con la pestaña",
    "Video looping on": "Repetición de vídeo activada",
    "Video looping off": "Repetición de vídeo desactivada",
    "Playlist pinning on": "Fijación de listas activada",
    "Playlist pinning off": "Fijación de listas desactivada",
    "Filters enabled": "Filtros activados",
    "Filters disabled": "Filtros desactivados",
    "Seen-post dimming on": "Atenuación de publicaciones vistas activada",
    "Seen-post dimming off": "Atenuación de publicaciones vistas desactivada",
    ...
    "Cleared {removed} hidden post.": "Se eliminó {removed} publicación oculta.",
    ...
    "Try a shorter word, or pick a section on the left.": "Prueba con una palabra más corta o elige una sección a la izquierda.",
    "This userscript manager does not give Aviary access to the page itself.": "Este gestor de userscripts no da a Aviary acceso a la propia página.",
    "This browser did not load Aviary's page script.": "Este navegador no cargó el script de página de Aviary.",
    ...
    "No matches (or integration disabled).": "No hay coincidencias (o la integración está desactivada).",
    "Open a profile's followers or following list, then use Capture snapshot to record it.": "Abre la lista de seguidores o seguidos de un perfil y usa «Capturar instantánea» para registrarla.",
    "No captured records match “{query}”.": "No hay registros capturados que coincidan con «{query}».",
    "Search all local collections": "Buscar en todas las colecciones locales",
    "Search posts, likes, bookmarks, notes, tags, folders, and snapshots with filters.": "Buscar publicaciones, Me gusta, marcadores, notas, etiquetas, carpetas e instantáneas con filtros.",
    ...
    "Use semantic ranking (optional)": "Usar clasificación semántica (opcional)",
    "Try source:bookmarks, tag:reading, or has:media.": "Prueba source:bookmarks, tag:reading o has:media.",
    "No local collections match this search.": "Ninguna colección local coincide con esta búsqueda.",
    "(no text)": "(sin texto)",
    ...
    "Nothing saved yet. Use Save locally on any post to keep a copy here.": "Aún no has guardado nada. Usa «Guardar localmente» en cualquier publicación para conservar una copia aquí.",
    "No local bookmarks match this search.": "Ningún marcador local coincide con esta búsqueda.",
    "Notes": "Notas",
    "Bookmark notes": "Notas del marcador",
    "Remove": "Eliminar",
    "Add one below as handle: note. Notes appear beside that account's posts.": "Añade una abajo con el formato usuario: nota. Las notas aparecen junto a las publicaciones de esa cuenta.",
    "Turn Capture on, scroll a timeline, then export. Jobs and their records appear here.": "Activa la captura, desplázate por una cronología y luego exporta. Los trabajos y sus registros aparecerán aquí.",
    "Formerly observed markers are no longer detected: {markers}.": "Ya no se detectan marcadores observados anteriormente: {markers}.",
    "X is in {language}, which Aviary has no ad labels for. Sponsored posts are not suppressed by label here.": "X está en {language}, un idioma para el que Aviary no tiene etiquetas de anuncios. Aquí las publicaciones patrocinadas no se ocultan por etiqueta.",
    "gid {gid} · {status}": "ID {gid} · {status}",
    "{count} entries": "{count} entradas",
    "{posts} posts · {likes} likes · {messages} direct messages (kept out of public search) · {media} media refs · {followers} followers · {following} following · {lists} lists": "{posts} publicaciones · {likes} me gusta · {messages} mensajes directos (fuera de la búsqueda pública) · {media} referencias multimedia · {followers} seguidores · {following} seguidos · {lists} listas",
    "{status} · {filename} · {records} records · {files} files · {warnings} warnings": "{status} · {filename} · {records} registros · {files} archivos · {warnings} advertencias",
    "{saved} saved · {due} due · {tags} tags · {folders} folders": "{saved} guardados · {due} pendientes · {tags} etiquetas · {folders} carpetas",
    "{status} · {records} records · {surface}": "{status} · {records} registros · {surface}",
    "{count} this session": "{count} en esta sesión",
    "Forget the stored warnings and errors. Only Aviary's own message text, the time, and the names of its detail fields are ever written here.": "Olvida los avisos y errores almacenados. Aquí solo se escriben el texto de los mensajes de Aviary, la hora y los nombres de sus campos de detalle.",
    "Clear the bounded local marker history and its drift warning. No post text, handles, URLs, or response bodies are stored here.": "Borra el historial local limitado de marcadores y su aviso de desviación. Aquí no se almacenan textos de publicaciones, nombres de usuario, URL ni cuerpos de respuesta.",
    ...
    "Assign legacy data here": "Asignar aquí datos heredados",
    ...
    "Dry-run restore": "Simular restauración",
    ...
    "Archive import": "Importación de archivo",
    "Pause archive import": "Pausar importación del archivo",
    "Resume archive import": "Reanudar importación del archivo",
    "Cancel archive import": "Cancelar importación del archivo",
    "Retry archive import": "Reintentar importación del archivo",
    "Local bookmarks": "Marcadores locales",
    "Clear local bookmarks": "Borrar marcadores locales",
    "No account notes yet": "Aún no hay notas de cuentas",
    "No export jobs yet": "Aún no hay trabajos de exportación",
    "Export job": "Trabajo de exportación",
    "Pause export job": "Pausar trabajo de exportación",
    "Resume export job": "Reanudar trabajo de exportación",
    "Cancel export job": "Cancelar trabajo de exportación",
    ...
    "Nothing is sent until you choose Send request.": "No se envía nada hasta que elijas Enviar solicitud.",
    "unlimited": "ilimitado",
    "Aviary stores usage counters only; the provider's retention follows its policy.": "Aviary solo guarda contadores de uso; la retención del proveedor sigue su política.",
    "Budget blocked this request.": "El presupuesto bloqueó esta solicitud.",
    ...
    "Aviary is on": "Aviary está activo",
    "Two things are enabled from the start. Everything else stays off until you turn it on.": "Dos cosas están activadas desde el principio. Todo lo demás permanece desactivado hasta que tú lo actives.",
    "Sponsored posts, promoted trends and pre-rolls are hidden.": "Las publicaciones patrocinadas, las tendencias promocionadas y los anuncios previos están ocultos.",
    "Photos and videos get a save control that only acts when you click it.": "Las fotos y los vídeos reciben un control de guardado que solo actúa cuando haces clic en él.",
    "Open Aviary from the last row of X's left navigation to change any of it.": "Abre Aviary desde la última fila de la navegación izquierda de X para cambiar cualquiera de estas opciones.",
    "Got it": "Entendido",
    "Hide trends, row borders and engagement counts, dim premium posts, strip t.co, dense + dim theme.": "Oculta tendencias, bordes de fila y contadores de interacción, atenúa las publicaciones premium, limpia t.co, tema denso y tenue.",
    ...
    "Aviary is covering the timeline until your next window. Nothing is blocked and nothing left this device.": "Aviary cubre la cronología hasta tu próximo intervalo. No se bloquea nada y nada salió de este dispositivo.",
    "Let me through for five minutes": "Déjame pasar cinco minutos",
    "Bookmark failed": "Error al guardar el marcador.",
    "Save locally": "Guardar localmente",
    "Remove local bookmark": "Eliminar marcador local",
    "Note": "Nota",
    "Tag": "Etiqueta",
    "Download access was not granted. Open Aviary Options to enable browser downloads.": "No se concedió el acceso de descarga. Abre las opciones de Aviary para habilitar las descargas del navegador.",
    "Media download failed. Try the on-post button again.": "Falló la descarga del contenido. Vuelve a intentarlo con el botón de la publicación.",
    "Right-click an image or video first, then choose Aviary download.": "Haz clic derecho en una imagen o un vídeo y luego elige la descarga de Aviary.",
    "Download": "Descargar",
    "Download all media in this post": "Descargar todo el contenido multimedia de esta publicación",
    "The direct video is still loading. Try again in a moment.": "El vídeo directo aún se está cargando. Inténtalo de nuevo en un momento.",
    ...
    "This image is not available to download.": "Esta imagen no está disponible para descargar.",
    "Queued": "En cola",
    "Saved": "Guardado",
    "Allow": "Permitir",
    "Retry": "Reintentar",
    ...
    "Aviary ships with the narrowest permission set that still works. Everything below is optional, granted only by you, and revocable from this page at any time. Nothing on this page sends data anywhere.": "Aviary se instala con el conjunto de permisos más reducido que sigue funcionando. Todo lo de abajo es opcional, lo concedes tú y puedes revocarlo desde esta página cuando quieras. Nada de esta página envía datos a ningún sitio.",
    "Permission health": "Estado de los permisos",
    "granted": "concedido",
    "optional": "opcionales",
    "All optional. You're in control.": "Todo es opcional. Tú tienes el control.",
    "Save media to disk": "Guardar medios en el disco",
    "checking…": "comprobando…",
    "Lets the Save and Thumb buttons write files through the browser's download manager, with your filename template and duplicate history. Without it the browser opens media in a tab instead of saving it.": "Permite que los botones Guardar y Miniatura escriban archivos con el gestor de descargas del navegador, con tu plantilla de nombres y el historial de duplicados. Sin él, el navegador abre los medios en una pestaña en lugar de guardarlos.",
    "Grant download access": "Conceder acceso a descargas",
    "Revoke": "Revocar",
    "Read media hosts directly": "Leer los servidores de medios directamente",
    "Adds the media hosts so large files can be fetched without a page round-trip. Optional — media buttons work without it.": "Añade los servidores de medios para descargar archivos grandes sin pasar por la página. Opcional: los botones de medios funcionan sin esto.",
    "Grant media hosts": "Conceder servidores de medios",
    "Settings, filters, notes and archives live in the Control Center on x.com. This page only manages browser permissions.": "Los ajustes, filtros, notas y archivos están en el Centro de control en x.com. Esta página solo gestiona los permisos del navegador.",
    ...
    "Granted. Aviary can read full-size media directly for exports now.": "Concedido. Ahora Aviary puede leer medios a tamaño completo para las exportaciones.",
    "Aviary archive": "Archivo de Aviary",
    "Local archive viewer — remote references are never fetched automatically.": "Visor de archivo local — las referencias remotas nunca se descargan automáticamente.",
    "Search records": "Buscar registros",
    "Media status": "Estado multimedia",
    "All media": "Todo el contenido",
    "Captured bytes": "Bytes capturados",
    "Remote reference": "Referencia remota",
    "Missing": "Faltante",
    "Sort": "Ordenar",
    "Newest first": "Más recientes primero",
    "Oldest first": "Más antiguos primero",
    "Handle": "Usuario",
    "Thread view": "Vista de hilos",
    "records": "registros",
    "shown": "mostrados",
    ...
    "Stop before sending one AI request larger than this UTF-8 body. Use 0 for no per-request bound.": "Detén el envío de solicitudes de IA cuyo cuerpo UTF-8 supere este tamaño. Usa 0 para no limitar cada solicitud.",
    "Stop AI provider calls after this many UTF-8 request bytes in the local day. Use 0 for unlimited.": "Detén las llamadas al proveedor de IA después de estos bytes UTF-8 en el día local. Usa 0 para ilimitado.",
    "Stop before sending one record larger than this UTF-8 body. Use 0 for no per-record bound.": "Detén el envío de registros cuyo cuerpo UTF-8 supere este tamaño. Usa 0 para no limitar cada registro.",
    "Stop embedding calls after this many UTF-8 record bytes in the local day. Use 0 for unlimited.": "Detén las llamadas de embeddings después de estos bytes UTF-8 de registros en el día local. Usa 0 para ilimitado.",
    "Rewrite image URLs to name=orig before downloading.": "Reescribe las URL de imagen a name=orig antes de descargar.",
    "Only applies while Ad-free mode is on. Aviary refuses X's separate promoted-content logging request, the one ad request that can be separated from the timeline itself. Turn this off if X complains about an ad blocker: sponsored posts stay hidden and Aviary stops refusing any request at all.": "Solo se aplica mientras el modo sin anuncios está activo. Aviary rechaza la solicitud de registro de contenido promocionado de X, la única solicitud de anuncios que puede separarse de la propia cronología. Desactívalo si X se queja de un bloqueador de anuncios: las publicaciones patrocinadas siguen ocultas y Aviary deja de rechazar cualquier solicitud.",
    "Always play video at the highest quality": "Reproducir siempre el vídeo con la máxima calidad",
    "X picks a video quality to suit your connection, and on a fast connection it often settles below the best one available. This pins every video to its highest rendition. It uses more data.": "X elige una calidad de vídeo acorde a tu conexión y, en conexiones rápidas, suele quedarse por debajo de la mejor disponible. Esto fija cada vídeo en su máxima resolución. Consume más datos.",
    "Best video quality on": "Máxima calidad de vídeo activada",
    "Video quality left to X": "Calidad de vídeo a criterio de X",
    "Hide reply, repost, like, and view numbers. The controls still work and screen readers still announce the totals.": "Oculta los números de respuestas, reposts, me gusta y visualizaciones. Los controles siguen funcionando y los lectores de pantalla siguen anunciando los totales.",
    "Original quality is applied when download controls are enabled.": "La calidad original se aplica cuando los controles de descarga están habilitados.",
    "One stable X navigation id per line: home, explore, notifications, messages, profile, more, or premium.": "Un ID estable de navegación de X por línea: home, explore, notifications, messages, profile, more o premium.",
    ...
    "Photos and videos": "Fotos y vídeos",
    "Default (X decides)": "Predeterminado (lo decide X)",
    "Reveal media X has hidden": "Mostrar el contenido que X ha ocultado",
    "Blur every photo and video": "Desenfocar todas las fotos y vídeos",
    "Hide every photo and video": "Ocultar todas las fotos y vídeos",
    "Photo and video display saved": "Preferencia de fotos y vídeos guardada",
  ...
  pt: {
    ...
    "Close": "Fechar",
    "Aviary settings": "Definições do Aviary",
    ...
    "Preset packs": "Pacotes de predefinições",
    "Language": "Idioma",
    "Theme": "Tema",
    "Noir adds Aviary's premium cyan-violet skin; Off leaves X's own styling untouched.": "Noir adiciona o visual premium em ciano e violeta da Aviary; Desativado mantém o estilo do X intacto.",
    "Off (X's own theme)": "Desativado (o tema do próprio X)",
    "Dim": "Escurecido",
    ...
    "Master switch for the four numbers below. The controls still work and screen readers still announce the totals.": "Interruptor principal dos quatro números abaixo. Os controles continuam funcionando e os leitores de tela continuam anunciando os totais.",
    "Hide reply counts": "Ocultar a contagem de respostas",
    "Applies while Hide engagement counts is on.": "Aplica-se enquanto \"Ocultar contagens de interação\" estiver ativo.",
    "Hide repost counts": "Ocultar a contagem de reposts",
    "Hide like counts": "Ocultar a contagem de curtidas",
    "Hide view counts": "Ocultar a contagem de visualizações",
    "Applies while Hide engagement counts is on. The view total lives in an analytics link, not an action button.": "Aplica-se enquanto \"Ocultar contagens de interação\" estiver ativo. O total de visualizações fica em um link de análises, não em um botão de ação.",
    "Hide the tab title badge": "Ocultar o contador no título da aba",
    "Remove X's unread count from the browser tab title, so a hidden notification badge is not restored by the tab.": "Remove a contagem de não lidos do X do título da aba, para que a aba não traga de volta um aviso que você já ocultou.",
    "Absolute timestamps": "Carimbos de data/hora absolutos",
    "Show the exact date and time on every post instead of X's relative text.": "Mostra a data e a hora exatas em cada publicação em vez do texto relativo do X.",
    "Use Aviary's tab icon": "Usar o ícone de aba do Aviary",
    "Replace X's favicon with Aviary's mark so its tabs are easy to pick out. Restores X's own icon when off.": "Substitui o favicon do X pela marca do Aviary para identificar suas abas rapidamente. Ao desativar, restaura o ícone original do X.",
    ...
    "Protection starts at document load.": "A proteção começa ao carregar o documento.",
    "Ad-free mode": "Modo sem anúncios",
    "Collapse sponsored posts, paid partnerships, promoted trends, house promos, and visible pre-rolls. Aviary also refuses X's separate promoted-content logging call without blocking timeline delivery.": "Oculta posts patrocinados, parcerias pagas, tendências promovidas, promoções da própria plataforma e anúncios de pré-reprodução visíveis. O Aviary também recusa a chamada separada de registo de conteúdo promovido do X sem bloquear a entrega da cronologia.",
    "Refuse X's ad logging call": "Recusar a chamada de registro de anúncios do X",
    "Only applies while Ad-free mode is on. Aviary refuses exactly one request — X's separate promoted-content logging call — and nothing else, including the checks X uses to notice an ad blocker. Turn this off if X complains anyway: sponsored posts stay hidden and Aviary stops refusing any request at all.": "Só se aplica enquanto o modo sem anúncios está ativado. O Aviary recusa exatamente uma requisição — a chamada de registo de conteúdo promovido do X — e mais nenhuma, incluindo as verificações que o X usa para detetar um bloqueador de anúncios. Desative isto se o X reclamar mesmo assim: as publicações patrocinadas continuam ocultas e o Aviary deixa de recusar qualquer requisição.",
    "Ad protection status": "Estado da proteção contra anúncios",
    ...
    "Hide follow suggestions": "Ocultar sugestões de contas",
    "Remove Who to follow cards without hiding the rest of the sidebar.": "Remove os cartões «Quem seguir» sem ocultar o resto da barra lateral.",
    "Hide home composer": "Ocultar o editor da página inicial",
    "Remove the quick-post composer from Home. The Post button still opens it when needed.": "Remove o editor de publicação rápida da página inicial. O botão Publicar continua a abri-lo quando necessário.",
    "Hide thread recommendations": "Ocultar recomendações da conversa",
    "Stop a conversation at its last real reply by collapsing the Discover more block and the suggested posts below it.": "Encerra a conversa na última resposta real, recolhendo o bloco Descobrir mais e as publicações sugeridas abaixo.",
    "Hide Grok surfaces": "Ocultar superfícies do Grok",
    "Remove the Grok drawer, navigation link, image-generation entries, and per-post actions where detected.": "Remove o painel e o link de navegação do Grok, as entradas de geração de imagens e as ações por publicação.",
    "Focus mode": "Modo foco",
    "Outside the hours below, cover the reading column with a calm local panel. Navigation stays usable and a five-minute override is one click away. Nothing is blocked and nothing leaves this device.": "Fora do horário abaixo, cobre a coluna de leitura com um painel local discreto. A navegação continua utilizável e uma exceção de cinco minutos fica a um clique. Nada é bloqueado e nada sai deste dispositivo.",
    "Reading hours start": "Início do horário de leitura",
    "24-hour time, for example 09:00.": "Hora no formato de 24 horas, por exemplo 09:00.",
    "Reading hours end": "Fim do horário de leitura",
    "24-hour time. An end before the start wraps past midnight.": "Hora no formato de 24 horas. Se o fim vier antes do início, o intervalo atravessa a meia-noite.",
    ...
    "Hide navigation items": "Ocultar itens de navegação",
    "One stable X navigation id per line: home, explore, notifications, follow, chat, grok, history, studio, premium, profile, or more.": "Um ID de navegação estável do X por linha: home, explore, notifications, follow, chat, grok, history, studio, premium, profile ou more.",
    "Ad protection": "Proteção contra anúncios",
    "Page chrome": "Elementos da página",
    "Reading flow": "Fluxo de leitura",
    "Navigation": "Navegação",
    "Rules are active on the selected routes.": "As regras estão ativas nas rotas selecionadas.",
    ...
    "Inactive until filters are enabled. You can edit rules before turning them on.": "Inativo até os filtros serem ativados. Podes editar as regras antes de as ligares.",
    "Dim posts you have already seen": "Esmaecer publicações que você já viu",
    "Fade a post the second time it scrolls past, so a return trip down the timeline shows what is new. Hovering a faded post brings it back. Only post IDs are stored.": "Esmaece uma publicação na segunda vez que ela passa pela tela, para que uma nova descida pela linha do tempo mostre o que é novo. Passar o cursor sobre uma publicação esmaecida a restaura. Somente os IDs das publicações são armazenados.",
    "Filter rules": "Regras de filtragem",
    "One rule per line: field, optional not, operator, value. Fields are text, handle, media, verified, link; operators are contains, is, starts, ends, matches. Join with and / or, and prefix dim: to fade instead of hide. Example: dim: text contains sale and media is photo": "Uma regra por linha: campo, \"not\" opcional, operador e valor. Os campos são text, handle, media, verified e link; os operadores são contains, is, starts, ends e matches. Combine com \"and\" ou \"or\" e use o prefixo \"dim:\" para esmaecer em vez de ocultar. Exemplo: dim: text contains sale and media is photo",
    ...
    "Routes": "Rotas",
    "Hide buttons follow the setting above.": "Os botões Ocultar seguem a definição acima.",
    ...
    "Hide button status": "Estado dos botões Ocultar",
    "Activates when Hide dismissed posts is on.": "Ativa quando Ocultar posts dispensados está ligado.",
    ...
    "Keep video playing when the tab loses focus": "Manter o vídeo tocando ao trocar de aba",
    "X stops a playing video when you switch tabs. This resumes it when you come back. A video you paused yourself stays paused.": "O X interrompe o vídeo em reprodução quando você troca de aba. Isto o retoma quando você volta. Um vídeo que você mesmo pausou continua pausado.",
    "Loop videos": "Repetir vídeos",
    "Restart a video when it reaches the end instead of stopping.": "Reinicia o vídeo ao chegar ao fim em vez de parar.",
    "Pin video playlists to their best rendition": "Fixar as playlists de vídeo na melhor versão",
    "When X hands Aviary a playlist listing several qualities, keep only the highest. X often settles below the best available on a fast connection. This uses more data, and it can only act on playlists Aviary sees.": "Quando o X entrega ao Aviary uma playlist com várias qualidades, mantém apenas a mais alta. Em conexões rápidas, o X frequentemente fica abaixo da melhor disponível. Isto consome mais dados e só age sobre playlists que o Aviary vê.",
    "Playback": "Reprodução",
    "The download preference applies to every media control.": "A preferência de transferência aplica-se a todos os controlos de multimédia.",
    "Show download buttons": "Mostrar botões de download",
    "Add one Download action to each media post, plus per-asset controls.": "Adicione uma ação Transferir a cada publicação com mídia, além de controles por item.",
    ...
    "Maximum media downloads in flight during a batch (1-6).": "Máximo de downloads de mídia simultâneos durante um lote (1-6).",
    "Download pacing": "Ritmo de download",
    "Controls the opening burst and sustained pace of batch media requests.": "Controla o pico inicial e o ritmo contínuo das solicitações de mídia em lote.",
    "Conservative": "Conservador",
    "Balanced": "Equilibrado",
    ...
    "Capture media bytes in export": "Capturar bytes de mídia na exportação",
    "Fetch media during the export action and include successful bytes with length and checksum; failed items remain retryable references.": "Busca a mídia durante a exportação e inclui os bytes obtidos com tamanho e checksum; itens que falharem permanecem como referências que podem ser tentadas novamente.",
    ...
    "{jobs} jobs tracked · {queries} GraphQL IDs cached": "{jobs} trabalhos acompanhados · {queries} IDs GraphQL em cache",
    ...
    "Destination": "Destino",
    "Jobs": "Tarefas",
    "Show the AI button on posts": "Mostrar o botão de IA nas publicações",
    "Adds a button to every post that builds a Translate, Summarize, Explain or Fact-check prompt. Without an AI provider configured it copies the prompt to your clipboard; nothing is sent anywhere.": "Adiciona a cada publicação um botão que compõe um pedido de Traduzir, Resumir, Explicar ou Verificar factos. Sem um fornecedor de IA configurado, copia o pedido para a área de transferência; nada é enviado para lado nenhum.",
    ...
    "Format: handle: colour. One per line. Colours are amber, rose, violet, sky, green, or slate. An empty line removes the tag.": "Formato: usuário: cor. Uma por linha. As cores são amber, rose, violet, sky, green ou slate. Uma linha vazia remove a etiqueta.",
    ...
    "One snippet per line. Reusable replies / templates insert from the composer toolbar.": "Um trecho por linha. Respostas e modelos reutilizáveis inseridos pela barra de ferramentas do compositor.",
    "Save, search, organize, and revisit posts in a local bookmark library.": "Guarde, pesquise, organize e reveja publicações numa biblioteca local de marcadores.",
    "Post tools": "Ferramentas de posts",
    "Writing tools": "Ferramentas de escrita",
    "{count} entries · latest {kind} of {latestCount} @ {at}": "{count} entradas · mais recente: {kind}, {latestCount} em {at}",
    ...
    "Pick a ZIP exported from x.com. STORE and DEFLATE entries are supported; the source stays local while it is resumable.": "Escolha um ZIP exportado de x.com. São suportadas entradas STORE e DEFLATE; a origem permanece local enquanto puder ser retomada.",
    "Search captured records": "Pesquisar registos capturados",
    "Full-text search across the latest export collector run.": "Pesquisa de texto completo na execução mais recente do coletor de exportação.",
    "@handle, keyword, phrase…": "@utilizador, palavra-chave, frase…",
    "Type to search the records captured by export runs.": "Escreva para pesquisar os registos capturados pelas execuções de exportação.",
    ...
    "{total} items · queued {queued} · approved {approved} · skipped {skipped}": "{total} itens · em fila {queued} · aprovados {approved} · ignorados {skipped}",
    ...
    "Live snapshots": "Instantâneos ativos",
    ...
    "Aria2 active downloads": "Transferências ativas do Aria2",
    "Refresh to list in-flight transfers; tap Cancel to abort one.": "Atualize para listar transferências em curso; toque em Cancelar para interromper uma.",
    "Refresh": "Atualizar",
    ...
    "Crosspost as thread": "Publicar como tópico",
    ...
    "AI data disclosure": "Divulgação de dados da IA",
    "Before sending, Aviary shows the provider, endpoint, fields, character/token estimate, retention, and budget status.": "Antes de enviar, o Aviary mostra o provedor, endpoint, campos, estimativa de caracteres/tokens, retenção e status do orçamento.",
    "AI usage today": "Uso de IA hoje",
    "AI max request bytes": "Máximo de bytes por solicitação de IA",
    "Stop before sending one AI request larger than this UTF-8 body. Set 0 to block every AI request.": "Pare antes de enviar uma solicitação de IA maior que este corpo UTF-8. Use 0 para bloquear todas as solicitações de IA.",
    "AI daily request bytes": "Bytes diários de solicitações de IA",
    "Stop AI provider calls after this many UTF-8 request bytes in the local day. Set 0 to block every AI request.": "Pare as chamadas ao provedor de IA após esta quantidade de bytes UTF-8 de solicitação no dia local. Use 0 para bloquear todas as solicitações de IA.",
    "Semantic search": "Busca semântica",
    "Send captured record text to the configured embedding endpoint for similarity search. The destination, fields, retention, and byte budget are shown here.": "Envie o texto dos registros capturados ao endpoint de embeddings configurado para busca por similaridade. O destino, os campos, a retenção e o orçamento de bytes aparecem aqui.",
    ...
    "Embedding data disclosure": "Divulgação de dados dos embeddings",
    "A request contains the model and captured record text. Vectors and bounded text stay in Aviary's local index; provider retention follows its policy.": "Uma solicitação contém o modelo e o texto do registro capturado. Vetores e texto limitado ficam no índice local do Aviary; a retenção do provedor segue a política dele.",
    "Embedding usage today": "Uso de embeddings hoje",
    "Embedding max record bytes": "Máximo de bytes por registro de embedding",
    "Stop before sending one record larger than this UTF-8 body. Set 0 to block every embedding call.": "Pare antes de enviar um registro maior que este corpo UTF-8. Use 0 para bloquear todas as chamadas de incorporação.",
    "Embedding daily record bytes": "Bytes diários de registros de embeddings",
    "Stop embedding calls after this many UTF-8 record bytes in the local day. Set 0 to block every embedding call.": "Pare as chamadas de incorporação após esta quantidade de bytes UTF-8 de registro no dia local. Use 0 para bloquear todas as chamadas de incorporação.",
    "Auto-embed every export": "Gerar embeddings a cada exportação",
    "Before enabling, review the endpoint, captured-record fields, local retention, and daily byte budget above. After each export, embed in the background. Off by default.": "Antes de ativar, confira acima o endpoint, os campos dos registros capturados, a retenção local e o orçamento diário de bytes. Depois de cada exportação, gere embeddings em segundo plano. Desativado por padrão.",
    ...
    "Vector similarity over captured records. Embeddings run on demand.": "Similaridade vetorial nos registos capturados. Os embeddings são executados a pedido.",
    ...
    "Forget local request counters only. This does not remove the semantic index or provider credentials.": "Esqueça apenas os contadores locais de solicitações. Isso não remove o índice semântico nem as credenciais do provedor.",
    "on": "ativado",
    "off": "desativado",
    "configured": "configurado",
    ...
    "Recent integration errors": "Erros recentes de integração",
    "Drawn from the audit log; only failed integration calls show up.": "Obtidos do registo de auditoria; só são mostradas chamadas de integração falhadas.",
    "Connections": "Ligações",
    "Intelligence": "Inteligência",
    "Redacted — saved credentials will be kept.": "Redigidas — as credenciais salvas serão mantidas.",
    "Stop after the current collection and roll back anything already written.": "Pare após a coleção atual e reverta tudo o que já foi escrito.",
    ...
    "Apply the selected profile collections. A failed write rolls back the collections already changed.": "Aplique as coleções selecionadas do perfil. Uma falha de gravação reverte as coleções já alteradas.",
    "Credentials are redacted; the values already saved in this profile will be kept.": "As credenciais estão redigidas; os valores já salvos neste perfil serão mantidos.",
    "Reset all preferences": "Repor todas as preferências",
    "Restores Aviary's defaults: ad-free mode stays on and every other visual or behavior control returns to off. Saved posts, notes, bookmarks, and download history are kept.": "Restaura as predefinições do Aviary: o modo sem anúncios permanece ligado e todos os outros controlos visuais ou de comportamento voltam a ficar desligados. Os posts, notas, marcadores e histórico de transferências são mantidos.",
    ...
    "Downloads one versioned JSON backup of this profile's local collections. Credentials are excluded by default; restoring keeps the credentials already saved here.": "Baixa um backup JSON versionado das coleções locais deste perfil. As credenciais são excluídas por padrão; a restauração mantém as credenciais já salvas aqui.",
    "Choose a library backup": "Escolher um backup da biblioteca",
    "Select a JSON backup to inspect its versions, counts, conflicts, and checksum before changing local data.": "Selecione um backup JSON para conferir versões, quantidades, conflitos e soma de verificação antes de alterar os dados locais.",
    ...
    "Library backup": "Cópia de segurança da biblioteca",
    ...
    "Refuse X's analytics beacons": "Recusar os sinalizadores de análise do X",
    "Stops the tracking pings X sends as you scroll, click and pause. Only the analytics endpoints are refused — timeline, media and login traffic is untouched.": "Impede os sinais de rastreio que o X envia quando percorres, clicas e pausas. Só os pontos de análise são recusados — o tráfego da cronologia, da multimédia e do início de sessão fica intacto.",
    "Monitor selector health": "Monitorar a saúde dos seletores",
    "Check the current X surface for required and fallback anchors. Turn this off when you do not want selector diagnostics.": "Verifica a superfície atual do X em busca de âncoras obrigatórias e alternativas. Desative se não quiser diagnósticos de seletores.",
    "Connected to the page": "Ligado à página",
    "Page access": "Acesso à página",
    ...
    "Page hooks": "Integrações da página",
    ...
    "Save or revert your changes before leaving this section.": "Guarda ou reverte as alterações antes de sair desta secção.",
    "Action failed.": "A ação falhou.",
    "Saving...": "A guardar...",
    "Fix invalid values before saving.": "Corrija os valores inválidos antes de salvar.",
    "Local-only mode on": "Modo apenas local ativado",
    "Local-only mode off": "Modo apenas local desativado",
    "Analytics beacons refused": "Sinalizadores de análise recusados",
    "Analytics beacons allowed": "Sinalizadores de análise permitidos",
    "Selector health monitoring on": "Monitoramento da saúde dos seletores ativado",
    "Selector health monitoring off": "Monitoramento da saúde dos seletores desativado",
    "Saved warnings cleared.": "Avisos salvos limpos.",
    "Could not clear saved warnings.": "Não foi possível limpar os avisos salvos.",
    "Ad observations reset.": "Observações de anúncios redefinidas.",
    "Could not reset ad observations.": "Não foi possível redefinir as observações de anúncios.",
    "Profile switched. Reloading…": "Perfil alterado. A recarregar…",
    "Profile switch failed.": "Não foi possível alterar o perfil.",
    "Assigned {moved} stores; {skipped} already existed.": "Foram atribuídos {moved} armazenamentos; {skipped} já existiam.",
    "Profile created. Reloading…": "Perfil criado. A recarregar…",
    "Profile creation failed.": "Não foi possível criar o perfil.",
    ...
    "Aria2 unreachable: {error}": "O Aria2 está inacessível: {error}",
    "Aria2 connection test failed.": "Falha no teste de ligação ao Aria2.",
    ...
    "Bluesky crosspost failed.": "Falha na publicação cruzada para o Bluesky.",
    "Posted {posts} to Mastodon.{url}": "Foram publicados {posts} no Mastodon.{url}",
    "Mastodon failed: {error}": "Falha no Mastodon: {error}",
    "Mastodon crosspost failed.": "Falha na publicação cruzada para o Mastodon.",
    ...
    "AI request budget saved": "Orçamento de solicitações de IA salvo",
    "AI daily budget saved": "Orçamento diário de IA salvo",
    ...
    "Embedding request budget saved": "Orçamento de solicitações de embeddings salvo",
    "Embedding daily budget saved": "Orçamento diário de embeddings salvo",
    ...
    "Embedding stopped at the budget ({blocked} records were not sent).": "Os embeddings pararam no orçamento ({blocked} registros não foram enviados).",
    "Indexed: +{added} new · skipped {skipped} · errors {errors} · total {total}{trimmed}.": "Indexados: +{added} novos · ignorados {skipped} · erros {errors} · total {total}{trimmed}.",
    "Embedding failed.": "Os embeddings falharam.",
    "Semantic index cleared": "Índice semântico limpo",
    "Could not clear semantic index.": "Não foi possível limpar o índice semântico.",
    "AI and embedding usage cleared": "Uso de IA e embeddings limpo",
    "Could not clear AI and embedding usage.": "Não foi possível limpar o uso de IA e embeddings.",
    "Preferences reset. Ad-free mode is on.": "Preferências repostas. O modo sem anúncios está ligado.",
    "Could not reset settings.": "Não foi possível repor as definições.",
    "Settings exported.": "Definições exportadas.",
    "Could not export settings.": "Não foi possível exportar as definições.",
    "Settings imported. {warning}": "Definições importadas. {warning}",
    "Import failed: {errors}": "Falha na importação: {errors}",
    "Could not import settings.": "Não foi possível importar as definições.",
    "Library backup downloaded: {filename} ({collections} collections, {bytes}).": "Backup da biblioteca baixado: {filename} ({collections} coleções, {bytes}).",
    "Could not export full library backup.": "Não foi possível exportar o backup completo da biblioteca.",
    "Reading library backup…": "Lendo o backup da biblioteca…",
    "Backup loaded: {collections} collections, {conflicts} changes.": "Backup carregado: {collections} coleções, {conflicts} alterações.",
    "Could not read library backup.": "Não foi possível ler o backup da biblioteca.",
    "Cancelling restore…": "Cancelando a restauração…",
    "Dry-run complete. No local data changed.": "Simulação concluída. Nenhum dado local foi alterado.",
    "Dry-run failed: {errors}": "A simulação falhou: {errors}",
    "Could not dry-run library restore.": "Não foi possível simular a restauração da biblioteca.",
    "Library backup restored ({collections} collections). Reloading…": "Backup da biblioteca restaurado ({collections} coleções). Recarregando…",
    "Restore cancelled; local data was rolled back.": "Restauração cancelada; os dados locais foram revertidos.",
    "Restore cancelled.": "Restauração cancelada.",
    "Restore failed: {errors}": "A restauração falhou: {errors}",
    "Could not restore library backup.": "Não foi possível restaurar o backup da biblioteca.",
    ...
    "Archive import paused.": "Importação do arquivo pausada.",
    "Archive import resumed.": "Importação do arquivo retomada.",
    "Archive import cancelled.": "Importação do arquivo cancelada.",
    "Archive import retry started.": "Foi iniciada uma nova tentativa de importação do arquivo.",
    ...
    "Enqueued {added} items ({protected} protected skipped).": "Foram adicionados {added} itens à fila ({protected} protegidos ignorados).",
    ...
    "Could not update bookmark.": "Não foi possível atualizar o marcador.",
    "Bookmark removed.": "Marcador removido.",
    "Bookmark was already removed.": "O marcador já tinha sido removido.",
    "Could not remove bookmark.": "Não foi possível remover o marcador.",
    "Bookmarks cleared.": "Marcadores apagados.",
    "Could not clear bookmarks.": "Não foi possível apagar os marcadores.",
    "AI button on": "Botão de IA ativado",
    "AI button off": "Botão de IA desativado",
    ...
    "Media byte capture on": "Captura de bytes de mídia ativada",
    "Media byte capture off": "Captura de bytes de mídia desativada",
    ...
    "Export job paused.": "Trabalho de exportação pausado.",
    "Export job resumed.": "Trabalho de exportação retomado.",
    "Export job cancelled.": "Trabalho de exportação cancelado.",
    ...
    "Exported {records} records across {files} ZIPs → {filename}": "{records} registos exportados em {files} ZIPs → {filename}",
    "Exported {records} record → {filename}": "{records} registo exportado → {filename}",
    "Exported {records} records → {filename}": "{records} registos exportados → {filename}",
    ...
    "Copied {records} records to clipboard.": "{records} registos copiados para a área de transferência.",
    "Exported {records} records to {target}.": "{records} registos exportados para {target}.",
    ...
    "Concurrent download limit saved": "Limite de downloads simultâneos salvo",
    ...
    "No failed media jobs to retry.": "Não existem trabalhos de multimédia falhados para repetir.",
    "Preset applied: {preset} ({changes})": "Predefinição aplicada: {preset} ({changes})",
    "Preset already applied: {preset}": "A predefinição já estava aplicada: {preset}",
    ...
    "Count preference saved": "Preferência de contagem salva",
    "Tab title badge hidden": "Contador da aba oculto",
    "Tab title badge shown": "Contador da aba visível",
    "Absolute timestamps on": "Carimbos absolutos ativados",
    "Absolute timestamps off": "Carimbos absolutos desativados",
    "Aviary tab icon on": "Ícone de aba do Aviary ativado",
    "X tab icon restored": "Ícone de aba do X restaurado",
    ...
    "Ad-free mode on": "Modo sem anúncios ligado",
    "Ad-free mode off": "Modo sem anúncios desligado",
    "Ad logging refused": "Registro de anúncios recusado",
    "Ad logging allowed": "Registro de anúncios permitido",
    "Sidebar preference saved": "Preferência de barra lateral guardada",
    "Trend preference saved": "Preferência de tendências guardada",
    "Layout preference saved": "Preferência de layout guardada",
    "Grok preference saved": "Preferência do Grok guardada",
    "Focus mode on": "Modo foco ativado",
    "Focus mode off": "Modo foco desativado",
    "Reading hours saved": "Horário de leitura salvo",
    ...
    "Navigation visibility saved": "Visibilidade da navegação salva",
    "Offscreen video paused": "Vídeo fora do ecrã em pausa",
    "Offscreen video left playing": "Vídeo fora do ecrã continua a reproduzir",
    "Video keeps playing": "O vídeo continua tocando",
    "Video pauses with the tab": "O vídeo pausa junto com a aba",
    "Video looping on": "Repetição de vídeo ativada",
    "Video looping off": "Repetição de vídeo desativada",
    "Playlist pinning on": "Fixação de playlists ativada",
    "Playlist pinning off": "Fixação de playlists desativada",
    "Filters enabled": "Filtros ativados",
    "Filters disabled": "Filtros desativados",
    "Seen-post dimming on": "Esmaecimento de publicações vistas ativado",
    "Seen-post dimming off": "Esmaecimento de publicações vistas desativado",
    "Seen posts forgotten.": "Publicações vistas esquecidas.",
    "Could not clear seen posts.": "Não foi possível limpar as publicações vistas.",
    ...
    "Cleared {removed} hidden post.": "Foi limpa {removed} publicação oculta.",
    "Cleared {removed} hidden posts.": "Foram limpas {removed} publicações ocultas.",
    ...
    "Try a shorter word, or pick a section on the left.": "Tenta uma palavra mais curta ou escolhe uma secção à esquerda.",
    "This userscript manager does not give Aviary access to the page itself.": "Este gestor de userscripts não dá ao Aviary acesso à própria página.",
    "This browser did not load Aviary's page script.": "Este navegador não carregou o script de página do Aviary.",
    "Unavailable in this browser.": "Indisponível neste navegador.",
    "Selector matches": "Correspondências de seletores",
    "Missing required surfaces": "Superfícies obrigatórias ausentes",
    "Optional surfaces missing": "Superfícies opcionais ausentes",
    "Fallback selectors in use": "Seletores alternativos em uso",
    "Affected features": "Funcionalidades afetadas",
    "Last selector transition": "Última transição de seletores",
    "Ad observations": "Observações de anúncios",
    "Ad marker counts": "Contagens de marcadores de anúncios",
    "Ad contract drift": "Desvio do contrato de anúncios",
    "Retained ad observations": "Observações de anúncios mantidas",
    "Native": "Nativo",
    "Trend": "Tendência",
    "House promo": "Promoção interna",
    "Video": "Vídeo",
    "No active downloads.": "Não existem transferências ativas.",
    "Cancel": "Cancelar",
    "Blocked by local-only mode": "Bloqueado pelo modo somente local",
    "blocked (budget is 0)": "bloqueado (orçamento é 0)",
    "No matches (or integration disabled).": "Sem correspondências (ou a integração está desativada).",
    "Open a profile's followers or following list, then use Capture snapshot to record it.": "Abra a lista de seguidores ou de quem um perfil segue e use \"Capturar instantâneo\" para registrá-la.",
    "No captured records match “{query}”.": "Nenhum registo capturado corresponde a «{query}».",
    "Search all local collections": "Pesquisar todas as coleções locais",
    "Search posts, likes, bookmarks, notes, tags, folders, and snapshots with filters.": "Pesquisar publicações, gostos, marcadores, notas, etiquetas, pastas e instantâneos com filtros.",
    ...
    "Use semantic ranking (optional)": "Usar classificação semântica (opcional)",
    "Try source:bookmarks, tag:reading, or has:media.": "Experimente source:bookmarks, tag:reading ou has:media.",
    "No local collections match this search.": "Nenhuma coleção local corresponde a esta pesquisa.",
    "(no text)": "(sem texto)",
    "Find local bookmarks": "Encontrar marcadores locais",
    "Search saved posts by text, handle, tags, folder, or ID.": "Pesquise publicações guardadas por texto, utilizador, etiquetas, pasta ou ID.",
    "Search local bookmarks": "Pesquisar marcadores locais",
    "Nothing saved yet. Use Save locally on any post to keep a copy here.": "Nada salvo ainda. Use \"Salvar localmente\" em qualquer publicação para manter uma cópia aqui.",
    "No local bookmarks match this search.": "Nenhum marcador local corresponde a esta pesquisa.",
    "Notes": "Notas",
    "Bookmark notes": "Notas do marcador",
    "Remove": "Remover",
    "Add one below as handle: note. Notes appear beside that account's posts.": "Adicione uma abaixo no formato usuário: nota. As notas aparecem ao lado das publicações dessa conta.",
    ...
    "Formerly observed markers are no longer detected: {markers}.": "Marcadores observados anteriormente não são mais detectados: {markers}.",
    "X is in {language}, which Aviary has no ad labels for. Sponsored posts are not suppressed by label here.": "O X está em {language}, um idioma para o qual o Aviary não tem rótulos de anúncio. Aqui as publicações patrocinadas não são ocultadas por rótulo.",
    "gid {gid} · {status}": "ID {gid} · {status}",
    "{count} entries": "{count} entradas",
    "{posts} posts · {likes} likes · {messages} direct messages (kept out of public search) · {media} media refs · {followers} followers · {following} following · {lists} lists": "{posts} publicações · {likes} gostos · {messages} mensagens diretas (fora da pesquisa pública) · {media} referências multimédia · {followers} seguidores · {following} a seguir · {lists} listas",
    "{status} · {filename} · {records} records · {files} files · {warnings} warnings": "{status} · {filename} · {records} registos · {files} ficheiros · {warnings} avisos",
    "{saved} saved · {due} due · {tags} tags · {folders} folders": "{saved} guardados · {due} pendentes · {tags} etiquetas · {folders} pastas",
    "{status} · {records} records · {surface}": "{status} · {records} registos · {surface}",
    "{count} this session": "{count} nesta sessão",
    "Forget the stored warnings and errors. Only Aviary's own message text, the time, and the names of its detail fields are ever written here.": "Esquece os avisos e erros armazenados. Aqui são gravados apenas o texto das mensagens do Aviary, o horário e os nomes dos seus campos de detalhe.",
    "Clear the bounded local marker history and its drift warning. No post text, handles, URLs, or response bodies are stored here.": "Limpe o histórico local limitado de marcadores e seu aviso de desvio. Nenhum texto de publicação, nome de usuário, URL ou corpo de resposta é armazenado aqui.",
    "Pause {filename}.": "Pausar {filename}.",
    "Resume {filename}.": "Retomar {filename}.",
    "Cancel {filename}.": "Cancelar {filename}.",
    "Retry {filename}.": "Tentar novamente {filename}.",
    "Pause {jobId}.": "Pausar {jobId}.",
    "Resume {jobId}.": "Retomar {jobId}.",
    "Cancel {jobId}.": "Cancelar {jobId}.",
    "Ad labels for this language": "Rótulos de anúncio para este idioma",
    "Saved warnings": "Avisos salvos",
    "Clear saved warnings": "Limpar avisos salvos",
    "Reset ad observations": "Redefinir observações de anúncios",
    ...
    "Backup collections": "Coleções do backup",
    "Collection changes": "Alterações nas coleções",
    "Credentials": "Credenciais",
    "Backup warnings": "Avisos do backup",
    "Cancel restore": "Cancelar restauração",
    "Dry-run restore": "Simular restauração",
    "Restore this library backup": "Restaurar este backup da biblioteca",
    "No snapshots yet": "Ainda não há instantâneos",
    "Imported collections": "Coleções importadas",
    "Archive import": "Importação de arquivo",
    "Pause archive import": "Pausar importação do arquivo",
    "Resume archive import": "Retomar importação do arquivo",
    "Cancel archive import": "Cancelar importação do arquivo",
    "Retry archive import": "Tentar novamente a importação do arquivo",
    "Local bookmarks": "Marcadores locais",
    "Clear local bookmarks": "Limpar marcadores locais",
    "No account notes yet": "Ainda não há notas de contas",
    "No export jobs yet": "Ainda não há trabalhos de exportação",
    "Export job": "Tarefa de exportação",
    "Pause export job": "Pausar tarefa de exportação",
    "Resume export job": "Retomar tarefa de exportação",
    "Cancel export job": "Cancelar tarefa de exportação",
    "Active media batch": "Lote de mídia ativo",
    "Resume queued media": "Retomar mídia na fila",
    "Retry failed media": "Tentar novamente mídias com falha",
    "Playlists rewritten": "Playlists reescritas",
    "Forget seen posts": "Esquecer publicações vistas",
    "Rules that could not be read": "Regras que não puderam ser lidas",
    ...
    "Review external AI request": "Revisar solicitação externa de IA",
    "Nothing is sent until you choose Send request.": "Nada é enviado até você escolher Enviar solicitação.",
    "unlimited": "ilimitado",
    "Aviary stores usage counters only; the provider's retention follows its policy.": "O Aviary armazena apenas contadores de uso; a retenção do provedor segue a política dele.",
    "Budget blocked this request.": "O orçamento bloqueou esta solicitação.",
    ...
    "Aviary is on": "O Aviary está ativo",
    "Two things are enabled from the start. Everything else stays off until you turn it on.": "Duas coisas ficam ativadas desde o início. Todo o restante permanece desligado até você ativar.",
    "Sponsored posts, promoted trends and pre-rolls are hidden.": "Publicações patrocinadas, tendências promovidas e anúncios pré-vídeo ficam ocultos.",
    "Photos and videos get a save control that only acts when you click it.": "Fotos e vídeos ganham um controle de salvar que só age quando você clica nele.",
    "Open Aviary from the last row of X's left navigation to change any of it.": "Abra o Aviary na última linha da navegação esquerda do X para alterar qualquer uma dessas opções.",
    "Got it": "Entendi",
    "Hide trends, row borders and engagement counts, dim premium posts, strip t.co, dense + dim theme.": "Oculta tendências, limites de linha e contadores de interação, atenua publicações premium, limpa t.co, tema denso e esbatido.",
    "Media Archivist": "Arquivo de multimédia",
    "Original-quality downloads, deterministic filenames, dedup history, stacked media.": "Transferências com qualidade original, nomes de ficheiro determinísticos, histórico sem duplicados, multimédia empilhada.",
    "Creator": "Criador",
    ...
    "Outside your reading hours": "Fora do seu horário de leitura",
    "Aviary is covering the timeline until your next window. Nothing is blocked and nothing left this device.": "O Aviary está cobrindo a linha do tempo até o seu próximo intervalo. Nada é bloqueado e nada saiu deste dispositivo.",
    ...
    "Note": "Nota",
    "Tag": "Etiqueta",
    "Download access was not granted. Open Aviary Options to enable browser downloads.": "O acesso de download não foi concedido. Abra as opções do Aviary para ativar os downloads do navegador.",
    "Media download failed. Try the on-post button again.": "Falha ao baixar a mídia. Tente novamente pelo botão na publicação.",
    "Right-click an image or video first, then choose Aviary download.": "Clique com o botão direito em uma imagem ou vídeo e escolha o download do Aviary.",
    "Download": "Transferir",
    "Download all media in this post": "Transferir toda a mídia desta publicação",
    "The direct video is still loading. Try again in a moment.": "O vídeo direto ainda está carregando. Tente novamente em instantes.",
    ...
    "This image is not available to download.": "Esta imagem não está disponível para download.",
    "Queued": "Em fila",
    "Saved": "Guardado",
    "Allow": "Permitir",
    "Retry": "Tentar de novo",
    "Permissions": "Permissões",
    "Optional permissions": "Permissões opcionais",
    "Aviary ships with the narrowest permission set that still works. Everything below is optional, granted only by you, and revocable from this page at any time. Nothing on this page sends data anywhere.": "O Aviary vem com o conjunto de permissões mais reduzido que ainda funciona. Tudo abaixo é opcional, concedido apenas por ti e revogável nesta página a qualquer momento. Nada nesta página envia dados para lado nenhum.",
    "Permission health": "Estado das permissões",
    "granted": "concedido",
    "optional": "opcionais",
    "All optional. You're in control.": "Tudo é opcional. Tu manténs o controlo.",
    "Save media to disk": "Guardar multimédia no disco",
    "checking…": "a verificar…",
    "Lets the Save and Thumb buttons write files through the browser's download manager, with your filename template and duplicate history. Without it the browser opens media in a tab instead of saving it.": "Permite que os botões Guardar e Miniatura escrevam ficheiros através do gestor de transferências do navegador, com o teu modelo de nomes e o histórico de duplicados. Sem isso, o navegador abre a multimédia num separador em vez de a guardar.",
    "Grant download access": "Conceder acesso a transferências",
    "Revoke": "Revogar",
    "Read media hosts directly": "Ler os servidores de multimédia diretamente",
    "Adds the media hosts so large files can be fetched without a page round-trip. Optional — media buttons work without it.": "Adiciona os servidores de multimédia para obter ficheiros grandes sem passar pela página. Opcional — os botões de multimédia funcionam sem isto.",
    "Grant media hosts": "Conceder servidores de multimédia",
    "Settings, filters, notes and archives live in the Control Center on x.com. This page only manages browser permissions.": "As definições, filtros, notas e arquivos estão no Centro de Controlo em x.com. Esta página só gere as permissões do navegador.",
    "This browser did not expose the permissions API.": "Este navegador não expõe a API de permissões.",
    "Request dismissed — nothing changed.": "Pedido dispensado — nada mudou.",
    "Revoked.": "Revogado.",
    "Nothing to revoke.": "Não há nada para revogar.",
    "not granted": "não concedido",
    "Granted. Media saves through the browser now.": "Concedido. A multimédia passa agora a ser guardada pelo navegador.",
    "Granted. Aviary can read full-size media directly for exports now.": "Concedido. O Aviary pode agora ler multimédia em tamanho completo para as exportações.",
    "Aviary archive": "Arquivo Aviary",
    "Local archive viewer — remote references are never fetched automatically.": "Visualizador de arquivo local — referências remotas nunca são buscadas automaticamente.",
    "Search records": "Pesquisar registros",
    "Media status": "Status da mídia",
    "All media": "Todas as mídias",
    "Captured bytes": "Bytes capturados",
    "Remote reference": "Referência remota",
    "Missing": "Ausente",
    "Sort": "Ordenar",
    "Newest first": "Mais recentes primeiro",
    "Oldest first": "Mais antigas primeiro",
    "Handle": "Usuário",
    "Thread view": "Visualização de tópicos",
    "records": "registros",
    "shown": "exibidos",
    ...
    "network may be required": "a rede pode ser necessária",
    "Stop before sending one AI request larger than this UTF-8 body. Use 0 for no per-request bound.": "Pare antes de enviar uma solicitação de IA maior que este corpo UTF-8. Use 0 para não limitar cada solicitação.",
    "Stop AI provider calls after this many UTF-8 request bytes in the local day. Use 0 for unlimited.": "Pare as chamadas ao provedor de IA após estes bytes UTF-8 de solicitação no dia local. Use 0 para ilimitado.",
    "Stop before sending one record larger than this UTF-8 body. Use 0 for no per-record bound.": "Pare antes de enviar um registro maior que este corpo UTF-8. Use 0 para não limitar cada registro.",
    "Stop embedding calls after this many UTF-8 record bytes in the local day. Use 0 for unlimited.": "Pare as chamadas de embeddings após estes bytes UTF-8 de registros no dia local. Use 0 para ilimitado.",
    "Rewrite image URLs to name=orig before downloading.": "Reescreve as URLs de imagem para name=orig antes de baixar.",
    "Only applies while Ad-free mode is on. Aviary refuses X's separate promoted-content logging request, the one ad request that can be separated from the timeline itself. Turn this off if X complains about an ad blocker: sponsored posts stay hidden and Aviary stops refusing any request at all.": "Só se aplica enquanto o modo sem anúncios está ativo. O Aviary recusa a requisição separada de registro de conteúdo promovido do X, a única requisição de anúncio que pode ser separada da própria linha do tempo. Desative isto se o X reclamar de um bloqueador de anúncios: as publicações patrocinadas continuam ocultas e o Aviary deixa de recusar qualquer requisição.",
    "Always play video at the highest quality": "Reproduzir sempre o vídeo na máxima qualidade",
    "X picks a video quality to suit your connection, and on a fast connection it often settles below the best one available. This pins every video to its highest rendition. It uses more data.": "O X escolhe uma qualidade de vídeo adequada à tua ligação e, numa ligação rápida, fica muitas vezes abaixo da melhor disponível. Isto fixa cada vídeo na sua resolução máxima. Consome mais dados.",
    "Best video quality on": "Máxima qualidade de vídeo ativada",
    "Video quality left to X": "Qualidade de vídeo ao critério do X",
    "Hide reply, repost, like, and view numbers. The controls still work and screen readers still announce the totals.": "Oculta os números de respostas, reposts, curtidas e visualizações. Os controles continuam funcionando e os leitores de tela ainda anunciam os totais.",
    "Original quality is applied when download controls are enabled.": "A qualidade original é aplicada quando os controlos de transferência estão ativados.",
    "One stable X navigation id per line: home, explore, notifications, messages, profile, more, or premium.": "Um ID de navegação estável do X por linha: home, explore, notifications, messages, profile, more ou premium.",
    "Save list": "Salvar lista",
    "Reset everything to plain X": "Repor tudo para o X original",
    "Puts every setting back to its default, which is to change nothing about X at all. Your saved posts, notes, bookmarks and download history are kept — this only resets preferences.": "Devolve todas as definições ao valor predefinido, que é não alterar nada no X. As tuas publicações guardadas, notas, marcadores e histórico de transferências são mantidos — isto repõe apenas as preferências.",
    "Everything reset. X is untouched again.": "Tudo reposto. O X está intacto outra vez.",
    ...
    "Preset already applied": "A predefinição já estava aplicada",
    ...
    "Reveal media X has hidden": "Mostrar conteúdo que o X ocultou",
    "Blur every photo and video": "Desfocar todas as fotos e vídeos",
    "Hide every photo and video": "Ocultar todas as fotos e vídeos",
    "Photo and video display saved": "Preferência de fotos e vídeos guardada",
  ...
  fr: {
    ...
    "Close": "Fermer",
    "Aviary settings": "Paramètres d’Aviary",
    ...
    "Preset packs": "Packs de préréglages",
    "Language": "Langue",
    "Theme": "Thème",
    "Noir adds Aviary's premium cyan-violet skin; Off leaves X's own styling untouched.": "Noir applique l’habillage premium cyan et violet d’Aviary ; Désactivé laisse le style de X intact.",
    "Off (X's own theme)": "Désactivé (thème natif de X)",
    "Dim": "Sombre",
    ...
    "Master switch for the four numbers below. The controls still work and screen readers still announce the totals.": "Interrupteur principal des quatre nombres ci-dessous. Les contrôles restent utilisables et les lecteurs d'écran annoncent toujours les totaux.",
    "Hide reply counts": "Masquer le nombre de réponses",
    "Applies while Hide engagement counts is on.": "S'applique tant que « Masquer les compteurs d'engagement » est activé.",
    ...
    "Applies while Hide engagement counts is on. The view total lives in an analytics link, not an action button.": "S'applique tant que « Masquer les compteurs d'engagement » est activé. Le total des vues se trouve dans un lien d'analyse, pas dans un bouton d'action.",
    "Hide the tab title badge": "Masquer le compteur du titre d'onglet",
    "Remove X's unread count from the browser tab title, so a hidden notification badge is not restored by the tab.": "Retire le compteur de non-lus de X du titre de l'onglet, pour que l'onglet ne ramène pas une notification que vous aviez masquée.",
    ...
    "Use Aviary's tab icon": "Utiliser l'icône d'onglet d'Aviary",
    "Replace X's favicon with Aviary's mark so its tabs are easy to pick out. Restores X's own icon when off.": "Remplace le favicon de X par la marque d'Aviary pour repérer ses onglets d'un coup d'œil. Désactivé, l'icône d'origine de X revient.",
    ...
    "Protection starts at document load.": "La protection démarre au chargement du document.",
    "Ad-free mode": "Mode sans publicité",
    "Collapse sponsored posts, paid partnerships, promoted trends, house promos, and visible pre-rolls. Aviary also refuses X's separate promoted-content logging call without blocking timeline delivery.": "Masque les publications sponsorisées, partenariats rémunérés, tendances promues, promotions internes et pré-rolls visibles. Aviary refuse aussi l'appel séparé de journalisation du contenu promu de X sans bloquer la livraison du fil.",
    "Refuse X's ad logging call": "Refuser l'appel de journalisation publicitaire de X",
    "Only applies while Ad-free mode is on. Aviary refuses exactly one request — X's separate promoted-content logging call — and nothing else, including the checks X uses to notice an ad blocker. Turn this off if X complains anyway: sponsored posts stay hidden and Aviary stops refusing any request at all.": "Ne s'applique que lorsque le mode sans publicité est activé. Aviary refuse exactement une requête — l'appel de journalisation du contenu sponsorisé de X — et aucune autre, y compris les vérifications que X utilise pour repérer un bloqueur de publicités. Désactivez ceci si X se plaint quand même : les posts sponsorisés restent masqués et Aviary cesse de refuser la moindre requête.",
    "Ad protection status": "État de la protection publicitaire",
    ...
    "Remove Who to follow cards without hiding the rest of the sidebar.": "Supprime les cartes « Qui suivre » sans masquer le reste de la barre latérale.",
    "Hide home composer": "Masquer le rédacteur de l’accueil",
    "Remove the quick-post composer from Home. The Post button still opens it when needed.": "Supprime le rédacteur rapide de l’accueil. Le bouton Publier permet toujours de l’ouvrir au besoin.",
    "Hide thread recommendations": "Masquer les recommandations du fil",
    "Stop a conversation at its last real reply by collapsing the Discover more block and the suggested posts below it.": "Arrête la conversation à sa dernière vraie réponse en repliant le bloc Découvrir plus et les posts suggérés en dessous.",
    "Hide Grok surfaces": "Masquer les surfaces Grok",
    "Remove the Grok drawer, navigation link, image-generation entries, and per-post actions where detected.": "Supprime le panneau et le lien de navigation Grok, les entrées de génération d’images et les actions par publication.",
    "Focus mode": "Mode concentration",
    "Outside the hours below, cover the reading column with a calm local panel. Navigation stays usable and a five-minute override is one click away. Nothing is blocked and nothing leaves this device.": "En dehors des heures ci-dessous, couvre la colonne de lecture par un panneau local discret. La navigation reste utilisable et une dérogation de cinq minutes est à un clic. Rien n'est bloqué et rien ne quitte cet appareil.",
    "Reading hours start": "Début des heures de lecture",
    "24-hour time, for example 09:00.": "Heure au format 24 h, par exemple 09:00.",
    "Reading hours end": "Fin des heures de lecture",
    "24-hour time. An end before the start wraps past midnight.": "Heure au format 24 h. Une fin antérieure au début franchit minuit.",
    ...
    "Hide navigation items": "Masquer les éléments de navigation",
    ...
    "Page chrome": "Éléments de la page",
    "Reading flow": "Flux de lecture",
    "Navigation": "Parcours",
    "Rules are active on the selected routes.": "Les règles sont actives sur les routes sélectionnées.",
    ...
    "Rule status": "État des règles",
    "Inactive until filters are enabled. You can edit rules before turning them on.": "Inactif tant que les filtres ne sont pas activés. Vous pouvez modifier les règles avant de les activer.",
    "Dim posts you have already seen": "Atténuer les posts déjà vus",
    "Fade a post the second time it scrolls past, so a return trip down the timeline shows what is new. Hovering a faded post brings it back. Only post IDs are stored.": "Atténue un post la deuxième fois qu'il défile, pour qu'un nouveau passage dans le fil montre ce qui est nouveau. Le survol d'un post atténué le rétablit. Seuls les identifiants des posts sont conservés.",
    "Filter rules": "Règles de filtrage",
    "One rule per line: field, optional not, operator, value. Fields are text, handle, media, verified, link; operators are contains, is, starts, ends, matches. Join with and / or, and prefix dim: to fade instead of hide. Example: dim: text contains sale and media is photo": "Une règle par ligne : champ, « not » facultatif, opérateur, valeur. Les champs sont text, handle, media, verified et link ; les opérateurs sont contains, is, starts, ends et matches. Reliez-les par « and » ou « or », et préfixez par « dim: » pour atténuer au lieu de masquer. Exemple : dim: text contains sale and media is photo",
    ...
    "Filter status": "État des filtres",
    "Rules": "Règles",
    "Content types": "Types de contenu",
    "Routes": "Pages",
    "Hide buttons follow the setting above.": "Les boutons Masquer suivent le réglage ci-dessus.",
    ...
    "Hide button status": "État des boutons Masquer",
    "Activates when Hide dismissed posts is on.": "S'active lorsque Masquer les publications ignorées est activé.",
    ...
    "X stops a playing video when you switch tabs. This resumes it when you come back. A video you paused yourself stays paused.": "X arrête la vidéo en cours quand vous changez d'onglet. Ceci la relance à votre retour. Une vidéo que vous avez mise en pause le reste.",
    "Loop videos": "Lire les vidéos en boucle",
    "Restart a video when it reaches the end instead of stopping.": "Relance la vidéo à la fin au lieu de l'arrêter.",
    "Pin video playlists to their best rendition": "Fixer les playlists vidéo sur leur meilleure version",
    "When X hands Aviary a playlist listing several qualities, keep only the highest. X often settles below the best available on a fast connection. This uses more data, and it can only act on playlists Aviary sees.": "Quand X transmet à Aviary une playlist listant plusieurs qualités, ne garder que la plus élevée. Sur une connexion rapide, X se contente souvent d'une qualité inférieure à la meilleure disponible. Cela consomme plus de données et n'agit que sur les playlists qu'Aviary voit.",
    "Playback": "Lecture",
    "The download preference applies to every media control.": "La préférence de téléchargement s'applique à chaque contrôle multimédia.",
    "Show download buttons": "Afficher les boutons de téléchargement",
    "Add one Download action to each media post, plus per-asset controls.": "Ajoute une action Télécharger à chaque publication multimédia, ainsi que des commandes par élément.",
    "Prefer original quality": "Préférer la qualité d'origine",
    "Try source-format name=orig first, then 4096x4096 if it fails.": "Essaie d’abord name=orig dans le format source, puis 4096x4096 en cas d’échec.",
    "Original quality status": "État de la qualité d'origine",
    ...
    "Maximum media downloads in flight during a batch (1-6).": "Nombre maximal de téléchargements multimédias simultanés pendant un lot (1-6).",
    "Download pacing": "Cadence des téléchargements",
    "Controls the opening burst and sustained pace of batch media requests.": "Contrôle la rafale initiale et le rythme soutenu des requêtes multimédias par lot.",
    ...
    "On-post controls": "Contrôles sur les publications",
    ...
    "Capture media bytes in export": "Capturer les octets multimédias dans l’export",
    "Fetch media during the export action and include successful bytes with length and checksum; failed items remain retryable references.": "Récupère les médias pendant l’export et inclut les octets obtenus avec leur taille et leur somme de contrôle ; les éléments échoués restent des références réessayables.",
    ...
    "{jobs} jobs tracked · {queries} GraphQL IDs cached": "{jobs} tâches suivies · {queries} identifiants GraphQL en cache",
    ...
    "Adds a button to every post that builds a Translate, Summarize, Explain or Fact-check prompt. Without an AI provider configured it copies the prompt to your clipboard; nothing is sent anywhere.": "Ajoute à chaque post un bouton qui compose une requête Traduire, Résumer, Expliquer ou Vérifier. Sans fournisseur d'IA configuré, la requête est copiée dans le presse-papiers ; rien n'est envoyé nulle part.",
    ...
    "Format: handle: colour. One per line. Colours are amber, rose, violet, sky, green, or slate. An empty line removes the tag.": "Format : identifiant : couleur. Une par ligne. Les couleurs sont amber, rose, violet, sky, green ou slate. Une ligne vide retire l'étiquette.",
    ...
    "One snippet per line. Reusable replies / templates insert from the composer toolbar.": "Un extrait par ligne. Réponses et modèles réutilisables à insérer depuis la barre d’outils du composeur.",
    "Save, search, organize, and revisit posts in a local bookmark library.": "Enregistrez, recherchez, organisez et retrouvez vos publications dans une bibliothèque locale de marque-pages.",
    "Post tools": "Outils de publication",
    "Writing tools": "Outils d'écriture",
    "{count} entries · latest {kind} of {latestCount} @ {at}": "{count} entrées · dernier {kind} de {latestCount} à {at}",
    ...
    "Pick a ZIP exported from x.com. STORE and DEFLATE entries are supported; the source stays local while it is resumable.": "Choisissez un ZIP exporté depuis x.com. Les entrées STORE et DEFLATE sont prises en charge ; la source reste locale pendant sa reprise.",
    "Search captured records": "Rechercher les enregistrements capturés",
    "Full-text search across the latest export collector run.": "Recherche plein texte dans la dernière collecte d’exportation.",
    "@handle, keyword, phrase…": "@compte, mot-clé, phrase…",
    "Type to search the records captured by export runs.": "Saisissez votre recherche dans les enregistrements capturés par les exports.",
    ...
    "{total} items · queued {queued} · approved {approved} · skipped {skipped}": "{total} éléments · en attente {queued} · approuvés {approved} · ignorés {skipped}",
    ...
    "Live snapshots": "Instantanés actifs",
    ...
    "Aria2 active downloads": "Téléchargements Aria2 actifs",
    ...
    "Split on blank lines and reply each segment to the previous one.": "Sépare les paragraphes vides et répond à chaque segment au précédent.",
    ...
    "AI data disclosure": "Données envoyées à l’IA",
    "Before sending, Aviary shows the provider, endpoint, fields, character/token estimate, retention, and budget status.": "Avant l’envoi, Aviary affiche le fournisseur, le point de terminaison, les champs, l’estimation des caractères/tokens, la conservation et l’état du budget.",
    "AI usage today": "Utilisation de l’IA aujourd’hui",
    "AI max request bytes": "Octets maximum par requête IA",
    "Stop before sending one AI request larger than this UTF-8 body. Set 0 to block every AI request.": "Arrêter avant d’envoyer une requête IA dont le corps UTF-8 dépasse cette taille. Mettre 0 pour bloquer toutes les requêtes IA.",
    "AI daily request bytes": "Octets quotidiens des requêtes IA",
    "Stop AI provider calls after this many UTF-8 request bytes in the local day. Set 0 to block every AI request.": "Arrêter les appels au fournisseur IA après ce nombre d’octets UTF-8 de requête dans la journée locale. Mettre 0 pour bloquer toutes les requêtes IA.",
    "Semantic search": "Recherche sémantique",
    "Send captured record text to the configured embedding endpoint for similarity search. The destination, fields, retention, and byte budget are shown here.": "Envoyer le texte des enregistrements capturés au point de terminaison d’embeddings configuré pour la recherche par similarité. La destination, les champs, la conservation et le budget d’octets sont affichés ici.",
    ...
    "Embedding data disclosure": "Données envoyées aux embeddings",
    "A request contains the model and captured record text. Vectors and bounded text stay in Aviary's local index; provider retention follows its policy.": "Une requête contient le modèle et le texte de l’enregistrement capturé. Les vecteurs et le texte limité restent dans l’index local d’Aviary ; la conservation du fournisseur suit sa politique.",
    ...
    "Stop before sending one record larger than this UTF-8 body. Set 0 to block every embedding call.": "Arrêter avant d’envoyer un enregistrement dont le corps UTF-8 dépasse cette taille. Mettre 0 pour bloquer tous les appels d’embedding.",
    "Embedding daily record bytes": "Octets quotidiens des enregistrements d’embeddings",
    "Stop embedding calls after this many UTF-8 record bytes in the local day. Set 0 to block every embedding call.": "Arrêter les appels d’embedding après ce nombre d’octets UTF-8 d’enregistrement dans la journée locale. Mettre 0 pour bloquer tous les appels d’embedding.",
    "Auto-embed every export": "Indexer automatiquement chaque export",
    "Before enabling, review the endpoint, captured-record fields, local retention, and daily byte budget above. After each export, embed in the background. Off by default.": "Avant l’activation, vérifiez ci-dessus le point de terminaison, les champs des enregistrements capturés, la conservation locale et le budget quotidien d’octets. Après chaque exportation, les embeddings sont générés en arrière-plan. Désactivé par défaut.",
    ...
    "Vector similarity over captured records. Embeddings run on demand.": "Similarité vectorielle sur les enregistrements capturés. Les embeddings sont lancés à la demande.",
    "Describe what you're looking for…": "Décrivez votre recherche…",
    ...
    "Forget local request counters only. This does not remove the semantic index or provider credentials.": "Effacer uniquement les compteurs locaux de requêtes. Cela ne supprime ni l’index sémantique ni les identifiants du fournisseur.",
    "on": "activé",
    "off": "désactivé",
    "configured": "configuré",
    "missing endpoint": "point de terminaison manquant",
    "missing credentials": "identifiants manquants",
    "missing key/model": "clé ou modèle manquant",
    "indexed": "indexés",
    "{name}: {state} · {config}": "{name} : {state} · {config}",
    "{name}: {state} · {count} {indexed}": "{name} : {state} · {count} {indexed}",
    "Integration status": "État des intégrations",
    "Recent integration errors": "Erreurs d’intégration récentes",
    "Drawn from the audit log; only failed integration calls show up.": "Issues du journal d’audit ; seules les intégrations échouées apparaissent.",
    "Connections": "Connexions",
    "Intelligence": "Intelligence artificielle",
    "Redacted — saved credentials will be kept.": "Masqués ; les identifiants enregistrés seront conservés.",
    "Stop after the current collection and roll back anything already written.": "Arrêter après la collection actuelle et rétablir tout ce qui a déjà été écrit.",
    "Validate the backup and show the same conflicts without writing or removing any local data.": "Valider la sauvegarde et afficher les mêmes conflits sans écrire ni supprimer de données locales.",
    "Apply the selected profile collections. A failed write rolls back the collections already changed.": "Appliquer les collections sélectionnées du profil. Une écriture échouée rétablit les collections déjà modifiées.",
    "Credentials are redacted; the values already saved in this profile will be kept.": "Les identifiants sont masqués ; les valeurs déjà enregistrées dans ce profil seront conservées.",
    "Reset all preferences": "Réinitialiser toutes les préférences",
    "Restores Aviary's defaults: ad-free mode stays on and every other visual or behavior control returns to off. Saved posts, notes, bookmarks, and download history are kept.": "Restaure les valeurs par défaut d'Aviary : le mode sans publicité reste activé et tous les autres contrôles visuels ou de comportement sont désactivés. Les publications, notes, favoris et l'historique de téléchargement sont conservés.",
    ...
    "Import": "Importer",
    "Export full library backup": "Exporter une sauvegarde complète de la bibliothèque",
    "Downloads one versioned JSON backup of this profile's local collections. Credentials are excluded by default; restoring keeps the credentials already saved here.": "Télécharge une sauvegarde JSON versionnée des collections locales de ce profil. Les identifiants sont exclus par défaut ; la restauration conserve ceux déjà enregistrés ici.",
    "Choose a library backup": "Choisir une sauvegarde de bibliothèque",
    "Select a JSON backup to inspect its versions, counts, conflicts, and checksum before changing local data.": "Sélectionnez une sauvegarde JSON pour vérifier ses versions, quantités, conflits et somme de contrôle avant de modifier les données locales.",
    ...
    "Library backup": "Sauvegarde de la bibliothèque",
    ...
    "Stops the tracking pings X sends as you scroll, click and pause. Only the analytics endpoints are refused — timeline, media and login traffic is untouched.": "Bloque les signaux de suivi que X envoie lorsque vous faites défiler, cliquez et mettez en pause. Seuls les points d'analyse sont refusés : le trafic du fil, des médias et de la connexion reste intact.",
    "Monitor selector health": "Surveiller l’état des sélecteurs",
    "Check the current X surface for required and fallback anchors. Turn this off when you do not want selector diagnostics.": "Vérifie la surface X actuelle pour trouver les ancres requises et de secours. Désactivez cette option si vous ne voulez pas de diagnostics des sélecteurs.",
    "Connected to the page": "Connecté à la page",
    "Page access": "Accès à la page",
    "Beacons refused": "Balises refusées",
    ...
    "Privacy boundary": "Périmètre de confidentialité",
    "Page hooks": "Intégrations de page",
    ...
    "Saving...": "Enregistrement...",
    "Fix invalid values before saving.": "Corrigez les valeurs non valides avant d’enregistrer.",
    "Local-only mode on": "Mode local uniquement activé",
    "Local-only mode off": "Mode local uniquement désactivé",
    "Analytics beacons refused": "Balises d'analyse refusées",
    "Analytics beacons allowed": "Balises d'analyse autorisées",
    "Selector health monitoring on": "Surveillance de l’état des sélecteurs activée",
    "Selector health monitoring off": "Surveillance de l’état des sélecteurs désactivée",
    "Saved warnings cleared.": "Avertissements enregistrés effacés.",
    "Could not clear saved warnings.": "Impossible d'effacer les avertissements enregistrés.",
    "Ad observations reset.": "Observations publicitaires réinitialisées.",
    "Could not reset ad observations.": "Impossible de réinitialiser les observations publicitaires.",
    "Profile switched. Reloading…": "Profil changé. Rechargement…",
    "Profile switch failed.": "Échec du changement de profil.",
    "Assigned {moved} stores; {skipped} already existed.": "Stockages attribués : {moved} ; {skipped} existaient déjà.",
    "Profile created. Reloading…": "Profil créé. Rechargement…",
    "Profile creation failed.": "Échec de la création du profil.",
    ...
    "Aria2 connection test failed.": "Échec du test de connexion à Aria2.",
    "Cancelled {gid}.": "{gid} annulé.",
    "Aria2 cancel failed: {error}": "Échec de l’annulation d’Aria2 : {error}",
    "Aria2 cancel failed.": "Échec de l’annulation d’Aria2.",
    ...
    "Posted {posts} to Bluesky.{url}": "{posts} publications envoyées sur Bluesky.{url}",
    "Bluesky failed: {error}": "Échec de Bluesky : {error}",
    "Bluesky crosspost failed.": "Échec de la publication croisée vers Bluesky.",
    "Posted {posts} to Mastodon.{url}": "{posts} publications envoyées sur Mastodon.{url}",
    "Mastodon failed: {error}": "Échec de Mastodon : {error}",
    "Mastodon crosspost failed.": "Échec de la publication croisée vers Mastodon.",
    ...
    "AI request budget saved": "Budget des requêtes IA enregistré",
    "AI daily budget saved": "Budget quotidien IA enregistré",
    ...
    "Embedding request budget saved": "Budget des requêtes d’embedding enregistré",
    "Embedding daily budget saved": "Budget quotidien des embeddings enregistré",
    ...
    "Embedding stopped at the budget ({blocked} records were not sent).": "Les embeddings se sont arrêtés au budget ({blocked} enregistrements n’ont pas été envoyés).",
    "Indexed: +{added} new · skipped {skipped} · errors {errors} · total {total}{trimmed}.": "Indexation : +{added} nouvelles · ignorées {skipped} · erreurs {errors} · total {total}{trimmed}.",
    "Embedding failed.": "Le calcul des embeddings a échoué.",
    "Semantic index cleared": "Index sémantique effacé",
    "Could not clear semantic index.": "Impossible d’effacer l’index sémantique.",
    "AI and embedding usage cleared": "Utilisation de l’IA et des embeddings effacée",
    "Could not clear AI and embedding usage.": "Impossible d’effacer l’utilisation de l’IA et des embeddings.",
    "Preferences reset. Ad-free mode is on.": "Préférences réinitialisées. Le mode sans publicité est activé.",
    "Could not reset settings.": "Impossible de réinitialiser les réglages.",
    "Settings exported.": "Réglages exportés.",
    "Could not export settings.": "Impossible d'exporter les réglages.",
    "Settings imported. {warning}": "Paramètres importés. {warning}",
    "Import failed: {errors}": "Échec de l’importation : {errors}",
    "Could not import settings.": "Impossible d'importer les réglages.",
    "Library backup downloaded: {filename} ({collections} collections, {bytes}).": "Sauvegarde de la bibliothèque téléchargée : {filename} ({collections} collections, {bytes}).",
    "Could not export full library backup.": "Impossible d’exporter la sauvegarde complète de la bibliothèque.",
    "Reading library backup…": "Lecture de la sauvegarde de la bibliothèque…",
    "Backup loaded: {collections} collections, {conflicts} changes.": "Sauvegarde chargée : {collections} collections, {conflicts} changements.",
    "Could not read library backup.": "Impossible de lire la sauvegarde de la bibliothèque.",
    "Cancelling restore…": "Annulation de la restauration…",
    "Dry-run complete. No local data changed.": "Simulation terminée. Aucune donnée locale n’a changé.",
    "Dry-run failed: {errors}": "Échec de la simulation : {errors}",
    "Could not dry-run library restore.": "Impossible de simuler la restauration de la bibliothèque.",
    "Library backup restored ({collections} collections). Reloading…": "Sauvegarde de la bibliothèque restaurée ({collections} collections). Rechargement…",
    "Restore cancelled; local data was rolled back.": "Restauration annulée ; les données locales ont été rétablies.",
    "Restore cancelled.": "Restauration annulée.",
    "Restore failed: {errors}": "Échec de la restauration : {errors}",
    "Could not restore library backup.": "Impossible de restaurer la sauvegarde de la bibliothèque.",
    ...
    "Captured {count} followers for @{handle}.": "{count} abonnés capturés pour @{handle}.",
    "No UserCell rows found.": "Aucune ligne UserCell trouvée.",
    "Snapshot failed.": "L'instantané a échoué.",
    "Captured {count} following for @{handle}.": "{count} abonnements suivis capturés pour @{handle}.",
    ...
    "Archive import cancelled.": "Importation de l’archive annulée.",
    "Archive import retry started.": "Nouvelle tentative d’importation de l’archive démarrée.",
    "Reading archive — large files take a moment…": "Lecture de l'archive : les gros fichiers prennent un instant…",
    "Imported {records} records. Warnings: {warnings}; errors: {errors}. Files: {recognized} recognized, {skipped} skipped, {malformed} malformed.": "{records} enregistrements importés. Avertissements : {warnings} ; erreurs : {errors}. Fichiers : {recognized} reconnus, {skipped} ignorés, {malformed} malformés.",
    ...
    "Enqueued {added} items ({protected} protected skipped).": "{added} éléments ajoutés ({protected} protégés ignorés).",
    ...
    "Bookmark updated.": "Marque-page mis à jour.",
    "Could not update bookmark.": "Impossible de mettre à jour le marque-page.",
    "Bookmark removed.": "Marque-page supprimé.",
    "Bookmark was already removed.": "Le marque-page avait déjà été supprimé.",
    "Could not remove bookmark.": "Impossible de supprimer le marque-page.",
    "Bookmarks cleared.": "Marque-pages supprimés.",
    "Could not clear bookmarks.": "Impossible de supprimer les marque-pages.",
    "AI button on": "Bouton IA activé",
    "AI button off": "Bouton IA désactivé",
    ...
    "Account colours saved": "Couleurs de comptes enregistrées",
    ...
    "Media byte capture on": "Capture des octets multimédias activée",
    "Media byte capture off": "Capture des octets multimédias désactivée",
    ...
    "Export job paused.": "Tâche d’exportation suspendue.",
    "Export job resumed.": "Tâche d’exportation reprise.",
    "Export job cancelled.": "Tâche d’exportation annulée.",
    ...
    "Exported {records} records across {files} ZIPs → {filename}": "{records} enregistrements exportés dans {files} ZIP → {filename}",
    "Exported {records} record → {filename}": "{records} enregistrement exporté → {filename}",
    "Exported {records} records → {filename}": "{records} enregistrements exportés → {filename}",
    ...
    "WARC downloaded ({records} records).": "WARC téléchargé ({records} enregistrements).",
    "WARC export failed.": "Échec de l'export WARC.",
    "Copied {records} records to clipboard.": "{records} enregistrements copiés dans le presse-papiers.",
    "Exported {records} records to {target}.": "{records} enregistrements exportés vers {target}.",
    ...
    "Concurrent download limit saved": "Limite de téléchargements simultanés enregistrée",
    "Download pacing saved": "Cadence des téléchargements enregistrée",
    ...
    "No failed media jobs to retry.": "Aucune tâche multimédia échouée à réessayer.",
    "Preset applied: {preset} ({changes})": "Préréglage appliqué : {preset} ({changes})",
    "Preset already applied: {preset}": "Le préréglage était déjà appliqué : {preset}",
    ...
    "Count preference saved": "Préférence de compteurs enregistrée",
    "Tab title badge hidden": "Compteur d'onglet masqué",
    "Tab title badge shown": "Compteur d'onglet affiché",
    "Absolute timestamps on": "Horodatages absolus activés",
    "Absolute timestamps off": "Horodatages absolus désactivés",
    "Aviary tab icon on": "Icône d'onglet Aviary activée",
    "X tab icon restored": "Icône d'onglet de X restaurée",
    ...
    "Ad-free mode on": "Mode sans publicité activé",
    "Ad-free mode off": "Mode sans publicité désactivé",
    "Ad logging refused": "Journalisation publicitaire refusée",
    "Ad logging allowed": "Journalisation publicitaire autorisée",
    ...
    "Layout preference saved": "Préférence de mise en page enregistrée",
    "Grok preference saved": "Préférence Grok enregistrée",
    "Focus mode on": "Mode concentration activé",
    "Focus mode off": "Mode concentration désactivé",
    "Reading hours saved": "Heures de lecture enregistrées",
    ...
    "Navigation visibility saved": "Visibilité de la navigation enregistrée",
    "Offscreen video paused": "Vidéo hors écran mise en pause",
    "Offscreen video left playing": "Vidéo hors écran laissée en lecture",
    "Video keeps playing": "La vidéo continue",
    "Video pauses with the tab": "La vidéo se met en pause avec l'onglet",
    "Video looping on": "Lecture en boucle activée",
    "Video looping off": "Lecture en boucle désactivée",
    "Playlist pinning on": "Fixation des playlists activée",
    "Playlist pinning off": "Fixation des playlists désactivée",
    "Filters enabled": "Filtres activés",
    "Filters disabled": "Filtres désactivés",
    "Seen-post dimming on": "Atténuation des posts vus activée",
    "Seen-post dimming off": "Atténuation des posts vus désactivée",
    "Seen posts forgotten.": "Posts vus oubliés.",
    "Could not clear seen posts.": "Impossible d'effacer les posts vus.",
    "Filter rules saved": "Règles de filtrage enregistrées",
    ...
    "Cleared {removed} hidden post.": "{removed} publication masquée supprimée.",
    "Cleared {removed} hidden posts.": "{removed} publications masquées supprimées.",
    ...
    "Try a shorter word, or pick a section on the left.": "Essayez un mot plus court ou choisissez une section à gauche.",
    "This userscript manager does not give Aviary access to the page itself.": "Ce gestionnaire d'userscripts ne donne pas à Aviary l'accès à la page elle-même.",
    "This browser did not load Aviary's page script.": "Ce navigateur n'a pas chargé le script de page d'Aviary.",
    "Unavailable in this browser.": "Indisponible dans ce navigateur.",
    "Selector matches": "Correspondances des sélecteurs",
    "Missing required surfaces": "Surfaces obligatoires manquantes",
    "Optional surfaces missing": "Surfaces facultatives manquantes",
    "Fallback selectors in use": "Sélecteurs de secours utilisés",
    "Affected features": "Fonctionnalités concernées",
    "Last selector transition": "Dernière transition de sélecteur",
    "Ad observations": "Observations publicitaires",
    "Ad marker counts": "Nombre de marqueurs publicitaires",
    "Ad contract drift": "Dérive du contrat publicitaire",
    "Retained ad observations": "Observations publicitaires conservées",
    "Native": "Native",
    "Trend": "Tendance",
    ...
    "Cancel": "Annuler",
    "Blocked by local-only mode": "Bloqué par le mode local uniquement",
    "blocked (budget is 0)": "bloqué (budget à 0)",
    "No matches (or integration disabled).": "Aucun résultat (ou intégration désactivée).",
    "Open a profile's followers or following list, then use Capture snapshot to record it.": "Ouvrez la liste des abonnés ou des abonnements d'un profil, puis utilisez « Capturer un instantané » pour l'enregistrer.",
    "No captured records match “{query}”.": "Aucun enregistrement capturé ne correspond à « {query} ».",
    "Search all local collections": "Rechercher dans toutes les collections locales",
    "Search posts, likes, bookmarks, notes, tags, folders, and snapshots with filters.": "Rechercher des publications, mentions J’aime, signets, notes, tags, dossiers et instantanés avec des filtres.",
    "Search local library (source:, account:, tag:, from:, to:, has:media)": "Rechercher dans la bibliothèque locale (source:, account:, tag:, from:, to:, has:media)",
    "Use semantic ranking (optional)": "Utiliser le classement sémantique (facultatif)",
    "Try source:bookmarks, tag:reading, or has:media.": "Essayez source:bookmarks, tag:reading ou has:media.",
    "No local collections match this search.": "Aucune collection locale ne correspond à cette recherche.",
    "(no text)": "(sans texte)",
    "Find local bookmarks": "Trouver les marque-pages locaux",
    "Search saved posts by text, handle, tags, folder, or ID.": "Recherchez les publications enregistrées par texte, identifiant, tags, dossier ou ID.",
    "Search local bookmarks": "Rechercher dans les marque-pages locaux",
    "Nothing saved yet. Use Save locally on any post to keep a copy here.": "Rien d'enregistré pour l'instant. Utilisez « Enregistrer localement » sur un post pour en garder une copie ici.",
    "No local bookmarks match this search.": "Aucun marque-page local ne correspond à cette recherche.",
    "Notes": "Annotations",
    "Bookmark notes": "Notes du marque-page",
    "Remove": "Supprimer",
    "Add one below as handle: note. Notes appear beside that account's posts.": "Ajoutez-en une ci-dessous au format identifiant : note. Les notes apparaissent à côté des posts de ce compte.",
    "Turn Capture on, scroll a timeline, then export. Jobs and their records appear here.": "Activez la capture, faites défiler un fil, puis exportez. Les tâches et leurs enregistrements apparaissent ici.",
    "Formerly observed markers are no longer detected: {markers}.": "Les marqueurs précédemment observés ne sont plus détectés : {markers}.",
    "X is in {language}, which Aviary has no ad labels for. Sponsored posts are not suppressed by label here.": "X est en {language}, une langue pour laquelle Aviary n'a pas d'étiquettes publicitaires. Ici, les posts sponsorisés ne sont pas masqués par étiquette.",
    "gid {gid} · {status}": "ID {gid} · {status}",
    "{count} entries": "{count} entrées",
    "{posts} posts · {likes} likes · {messages} direct messages (kept out of public search) · {media} media refs · {followers} followers · {following} following · {lists} lists": "{posts} publications · {likes} mentions J’aime · {messages} messages directs (exclus de la recherche publique) · {media} références multimédias · {followers} abonnés · {following} abonnements · {lists} listes",
    "{status} · {filename} · {records} records · {files} files · {warnings} warnings": "{status} · {filename} · {records} enregistrements · {files} fichiers · {warnings} avertissements",
    "{saved} saved · {due} due · {tags} tags · {folders} folders": "{saved} enregistrés · {due} à traiter · {tags} tags · {folders} dossiers",
    "{status} · {records} records · {surface}": "{status} · {records} enregistrements · {surface}",
    "{count} this session": "{count} durant cette session",
    "Forget the stored warnings and errors. Only Aviary's own message text, the time, and the names of its detail fields are ever written here.": "Oublie les avertissements et erreurs stockés. Seuls le texte des messages d'Aviary, l'heure et les noms de ses champs de détail sont écrits ici.",
    "Clear the bounded local marker history and its drift warning. No post text, handles, URLs, or response bodies are stored here.": "Effacez l’historique local limité des marqueurs et son avertissement de dérive. Aucun texte de publication, identifiant, URL ou corps de réponse n’est stocké ici.",
    "Pause {filename}.": "Mettre {filename} en pause.",
    "Resume {filename}.": "Reprendre {filename}.",
    "Cancel {filename}.": "Annuler {filename}.",
    "Retry {filename}.": "Réessayer {filename}.",
    "Pause {jobId}.": "Mettre {jobId} en pause.",
    "Resume {jobId}.": "Reprendre {jobId}.",
    "Cancel {jobId}.": "Annuler {jobId}.",
    "Ad labels for this language": "Étiquettes publicitaires pour cette langue",
    "Saved warnings": "Avertissements enregistrés",
    "Clear saved warnings": "Effacer les avertissements enregistrés",
    "Reset ad observations": "Réinitialiser les observations publicitaires",
    "Active profile": "Profil actif",
    "Switch profile": "Changer de profil",
    "Assign legacy data here": "Attribuer ici les données héritées",
    ...
    "Restore this library backup": "Restaurer cette sauvegarde de bibliothèque",
    "No snapshots yet": "Aucun instantané pour l'instant",
    "Imported collections": "Collections importées",
    "Archive import": "Importation d’archive",
    "Pause archive import": "Mettre en pause l’importation de l’archive",
    "Resume archive import": "Reprendre l’importation de l’archive",
    "Cancel archive import": "Annuler l’importation de l’archive",
    "Retry archive import": "Réessayer l’importation de l’archive",
    ...
    "No export jobs yet": "Aucune tâche d'export pour l'instant",
    "Export job": "Tâche d’exportation",
    "Pause export job": "Mettre en pause la tâche d’exportation",
    "Resume export job": "Reprendre la tâche d’exportation",
    "Cancel export job": "Annuler la tâche d’exportation",
    "Active media batch": "Lot de médias actif",
    "Resume queued media": "Reprendre les médias en file",
    "Retry failed media": "Réessayer les médias échoués",
    "Playlists rewritten": "Playlists réécrites",
    "Forget seen posts": "Oublier les posts vus",
    "Rules that could not be read": "Règles illisibles",
    ...
    "Review external AI request": "Vérifier la requête IA externe",
    "Nothing is sent until you choose Send request.": "Rien n’est envoyé avant de choisir Envoyer la requête.",
    "unlimited": "illimité",
    ...
    "Budget blocked this request.": "Le budget a bloqué cette requête.",
    ...
    "Two things are enabled from the start. Everything else stays off until you turn it on.": "Deux choses sont activées dès le départ. Tout le reste reste désactivé jusqu'à ce que vous l'activiez.",
    "Sponsored posts, promoted trends and pre-rolls are hidden.": "Les posts sponsorisés, les tendances promues et les pre-rolls sont masqués.",
    "Photos and videos get a save control that only acts when you click it.": "Les photos et vidéos reçoivent un bouton d'enregistrement qui n'agit que lorsque vous cliquez dessus.",
    "Open Aviary from the last row of X's left navigation to change any of it.": "Ouvrez Aviary depuis la dernière ligne de la navigation gauche de X pour modifier tout cela.",
    "Got it": "Compris",
    "Hide trends, row borders and engagement counts, dim premium posts, strip t.co, dense + dim theme.": "Masque les tendances, les bordures de ligne et les compteurs d'interaction, atténue les posts premium, nettoie t.co, thème dense et sombre.",
    "Media Archivist": "Archiviste média",
    "Original-quality downloads, deterministic filenames, dedup history, stacked media.": "Téléchargements en qualité d'origine, noms de fichiers déterministes, historique dédupliqué, médias empilés.",
    "Creator": "Créateur",
    ...
    "Aviary is covering the timeline until your next window. Nothing is blocked and nothing left this device.": "Aviary masque le fil jusqu'à votre prochaine plage. Rien n'est bloqué et rien n'a quitté cet appareil.",
    "Let me through for five minutes": "Laisse-moi passer cinq minutes",
    "Bookmark failed": "Échec de l’enregistrement du marque-page.",
    "Save locally": "Enregistrer localement",
    "Remove local bookmark": "Supprimer le marque-page local",
    "Note": "Annotation",
    "Tag": "Étiquette",
    "Download access was not granted. Open Aviary Options to enable browser downloads.": "L'accès au téléchargement n'a pas été accordé. Ouvrez les options d'Aviary pour activer les téléchargements du navigateur.",
    "Media download failed. Try the on-post button again.": "Échec du téléchargement du média. Réessayez avec le bouton sur le post.",
    "Right-click an image or video first, then choose Aviary download.": "Faites un clic droit sur une image ou une vidéo, puis choisissez le téléchargement Aviary.",
    "Download": "Télécharger",
    "Download all media in this post": "Télécharger tous les médias de cette publication",
    "The direct video is still loading. Try again in a moment.": "La vidéo directe est encore en cours de chargement. Réessayez dans un instant.",
    ...
    "This image is not available to download.": "Cette image n'est pas disponible au téléchargement.",
    "Queued": "En file",
    "Saved": "Enregistré",
    "Allow": "Autoriser",
    "Retry": "Réessayer",
    ...
    "Aviary ships with the narrowest permission set that still works. Everything below is optional, granted only by you, and revocable from this page at any time. Nothing on this page sends data anywhere.": "Aviary est livré avec le jeu d'autorisations le plus restreint qui fonctionne encore. Tout ce qui suit est facultatif, accordé par vous seul et révocable depuis cette page à tout moment. Rien sur cette page n'envoie de données.",
    "Permission health": "État des autorisations",
    "granted": "accordé",
    "optional": "facultatives",
    "All optional. You're in control.": "Tout est facultatif. Vous gardez le contrôle.",
    "Save media to disk": "Enregistrer les médias sur le disque",
    "checking…": "vérification…",
    "Lets the Save and Thumb buttons write files through the browser's download manager, with your filename template and duplicate history. Without it the browser opens media in a tab instead of saving it.": "Permet aux boutons Enregistrer et Miniature d'écrire des fichiers via le gestionnaire de téléchargements du navigateur, avec votre modèle de nom et l'historique des doublons. Sans cela, le navigateur ouvre le média dans un onglet au lieu de l'enregistrer.",
    "Grant download access": "Autoriser les téléchargements",
    "Revoke": "Révoquer",
    "Read media hosts directly": "Lire directement les hôtes média",
    "Adds the media hosts so large files can be fetched without a page round-trip. Optional — media buttons work without it.": "Ajoute les hôtes média pour récupérer les gros fichiers sans passer par la page. Facultatif — les boutons média fonctionnent sans.",
    "Grant media hosts": "Autoriser les hôtes média",
    "Settings, filters, notes and archives live in the Control Center on x.com. This page only manages browser permissions.": "Les réglages, filtres, notes et archives se trouvent dans le Centre de contrôle sur x.com. Cette page ne gère que les autorisations du navigateur.",
    "This browser did not expose the permissions API.": "Ce navigateur n'expose pas l'API des autorisations.",
    "Request dismissed — nothing changed.": "Demande abandonnée — rien n'a changé.",
    "Revoked.": "Révoqué.",
    "Nothing to revoke.": "Rien à révoquer.",
    "not granted": "non accordé",
    "Granted. Media saves through the browser now.": "Accordé. Les médias sont désormais enregistrés par le navigateur.",
    "Granted. Aviary can read full-size media directly for exports now.": "Accordé. Aviary peut désormais lire les médias en taille réelle pour les exports.",
    "Aviary archive": "Archive Aviary",
    "Local archive viewer — remote references are never fetched automatically.": "Lecteur d’archive local — les références distantes ne sont jamais récupérées automatiquement.",
    "Search records": "Rechercher des entrées",
    "Media status": "État des médias",
    "All media": "Tous les médias",
    "Captured bytes": "Octets capturés",
    "Remote reference": "Référence distante",
    "Missing": "Manquant",
    "Sort": "Trier",
    "Newest first": "Plus récent d’abord",
    "Oldest first": "Plus ancien d’abord",
    "Handle": "Compte",
    "Thread view": "Vue des fils",
    "records": "entrées",
    "shown": "affichées",
    "No matching records.": "Aucune entrée correspondante.",
    "source": "source",
    "bytes": "octets",
    "SHA-256": "SHA-256",
    ...
    "network may be required": "réseau potentiellement nécessaire",
    "Stop before sending one AI request larger than this UTF-8 body. Use 0 for no per-request bound.": "Arrêter avant d’envoyer une requête IA dont le corps UTF-8 dépasse cette taille. Utiliser 0 pour ne pas limiter chaque requête.",
    "Stop AI provider calls after this many UTF-8 request bytes in the local day. Use 0 for unlimited.": "Arrêter les appels au fournisseur d’IA après ce nombre d’octets UTF-8 dans la journée locale. Utiliser 0 pour illimité.",
    "Stop before sending one record larger than this UTF-8 body. Use 0 for no per-record bound.": "Arrêter avant d’envoyer un enregistrement dont le corps UTF-8 dépasse cette taille. Utiliser 0 pour ne pas limiter chaque enregistrement.",
    "Stop embedding calls after this many UTF-8 record bytes in the local day. Use 0 for unlimited.": "Arrêter les appels d’embedding après ce nombre d’octets UTF-8 d’enregistrements dans la journée locale. Utiliser 0 pour illimité.",
    "Rewrite image URLs to name=orig before downloading.": "Réécrit les URL d'image en name=orig avant le téléchargement.",
    "Only applies while Ad-free mode is on. Aviary refuses X's separate promoted-content logging request, the one ad request that can be separated from the timeline itself. Turn this off if X complains about an ad blocker: sponsored posts stay hidden and Aviary stops refusing any request at all.": "Ne s'applique que si le mode sans publicité est activé. Aviary refuse la requête distincte de journalisation des contenus sponsorisés de X, la seule requête publicitaire séparable du fil lui-même. Désactivez ceci si X se plaint d'un bloqueur de publicités : les posts sponsorisés restent masqués et Aviary cesse de refuser la moindre requête.",
    "Always play video at the highest quality": "Toujours lire les vidéos en qualité maximale",
    "X picks a video quality to suit your connection, and on a fast connection it often settles below the best one available. This pins every video to its highest rendition. It uses more data.": "X choisit une qualité vidéo adaptée à votre connexion et, sur une connexion rapide, reste souvent en deçà de la meilleure disponible. Cette option fixe chaque vidéo sur sa définition la plus élevée. Elle consomme plus de données.",
    "Best video quality on": "Qualité vidéo maximale activée",
    "Video quality left to X": "Qualité vidéo laissée à X",
    "Hide reply, repost, like, and view numbers. The controls still work and screen readers still announce the totals.": "Masque le nombre de réponses, de republications, de mentions J’aime et de vues. Les contrôles fonctionnent toujours et les lecteurs d’écran annoncent encore les totaux.",
    "Original quality is applied when download controls are enabled.": "La qualité d'origine est appliquée lorsque les contrôles de téléchargement sont activés.",
    ...
    "Reset everything to plain X": "Tout réinitialiser au X d'origine",
    "Puts every setting back to its default, which is to change nothing about X at all. Your saved posts, notes, bookmarks and download history are kept — this only resets preferences.": "Remet chaque réglage à sa valeur par défaut, c'est-à-dire ne rien modifier sur X. Vos posts enregistrés, notes, favoris et historique de téléchargement sont conservés : seules les préférences sont réinitialisées.",
    "Everything reset. X is untouched again.": "Tout est réinitialisé. X est de nouveau intact.",
    ...
    "Preset already applied": "Préréglage déjà appliqué",
    ...
    "Default (X decides)": "Par défaut (choix de X)",
    "Reveal media X has hidden": "Afficher les médias masqués par X",
    "Blur every photo and video": "Flouter toutes les photos et vidéos",
    "Hide every photo and video": "Masquer toutes les photos et vidéos",
    "Photo and video display saved": "Préférence photos et vidéos enregistrée",
  ...
  de: {
    ...
    "Language": "Sprache",
    "Theme": "Design",
    "Noir adds Aviary's premium cyan-violet skin; Off leaves X's own styling untouched.": "Noir aktiviert Aviarys hochwertiges Cyan-Violett-Design; Aus lässt das Styling von X unverändert.",
    ...
    "Master switch for the four numbers below. The controls still work and screen readers still announce the totals.": "Hauptschalter für die vier Zahlen unten. Die Bedienelemente funktionieren weiterhin, und Screenreader nennen die Summen weiterhin.",
    ...
    "Hide like counts": "Gefällt-mir-Zahlen ausblenden",
    "Hide view counts": "Aufrufzahlen ausblenden",
    "Applies while Hide engagement counts is on. The view total lives in an analytics link, not an action button.": "Gilt, solange „Interaktionszahlen ausblenden“ aktiv ist. Die Aufrufsumme steht in einem Analyse-Link, nicht in einer Aktionsschaltfläche.",
    "Hide the tab title badge": "Zähler im Tab-Titel ausblenden",
    "Remove X's unread count from the browser tab title, so a hidden notification badge is not restored by the tab.": "Entfernt X' Ungelesen-Zähler aus dem Tab-Titel, damit der Tab keinen Hinweis zurückbringt, den du bereits ausgeblendet hast.",
    ...
    "Replace X's favicon with Aviary's mark so its tabs are easy to pick out. Restores X's own icon when off.": "Ersetzt X' Favicon durch Aviarys Marke, damit sich dessen Tabs leicht herausgreifen lassen. Ausgeschaltet kehrt X' eigenes Symbol zurück.",
    ...
    "Collapse sponsored posts, paid partnerships, promoted trends, house promos, and visible pre-rolls. Aviary also refuses X's separate promoted-content logging call without blocking timeline delivery.": "Blendet gesponserte Beiträge, bezahlte Partnerschaften, beworbene Trends, Eigenwerbung und sichtbare Pre-Rolls aus. Aviary verweigert außerdem den separaten Protokollierungsaufruf für beworbene Inhalte von X, ohne die Timeline-Auslieferung zu blockieren.",
    "Refuse X's ad logging call": "X' Werbe-Protokollaufruf ablehnen",
    "Only applies while Ad-free mode is on. Aviary refuses exactly one request — X's separate promoted-content logging call — and nothing else, including the checks X uses to notice an ad blocker. Turn this off if X complains anyway: sponsored posts stay hidden and Aviary stops refusing any request at all.": "Gilt nur, solange der werbefreie Modus aktiv ist. Aviary verweigert genau eine Anfrage — den separaten Protokollierungsaufruf für beworbene Inhalte von X — und sonst keine, auch nicht die Prüfungen, mit denen X einen Werbeblocker erkennt. Schalte dies aus, falls X sich trotzdem beschwert: Gesponserte Beiträge bleiben ausgeblendet und Aviary verweigert überhaupt keine Anfrage mehr.",
    ...
    "Hide follow suggestions": "Kontovorschläge ausblenden",
    ...
    "Remove the quick-post composer from Home. The Post button still opens it when needed.": "Entfernt den Schnellbeitrag-Editor auf der Startseite. Über die Schaltfläche „Posten“ lässt er sich bei Bedarf weiterhin öffnen.",
    "Hide thread recommendations": "Thread-Empfehlungen ausblenden",
    "Stop a conversation at its last real reply by collapsing the Discover more block and the suggested posts below it.": "Beendet die Unterhaltung bei der letzten echten Antwort und blendet den Bereich „Mehr entdecken“ samt der vorgeschlagenen Beiträge darunter aus.",
    "Hide Grok surfaces": "Grok-Oberflächen ausblenden",
    "Remove the Grok drawer, navigation link, image-generation entries, and per-post actions where detected.": "Blendet die Grok-Leiste und den Navigationslink, die Bildgenerierungseinträge und die Aktionen pro Beitrag aus.",
    "Focus mode": "Fokusmodus",
    "Outside the hours below, cover the reading column with a calm local panel. Navigation stays usable and a five-minute override is one click away. Nothing is blocked and nothing leaves this device.": "Außerhalb der Zeiten unten wird die Lesespalte mit einem ruhigen lokalen Feld abgedeckt. Die Navigation bleibt nutzbar, und eine Ausnahme von fünf Minuten ist einen Klick entfernt. Nichts wird blockiert, und nichts verlässt dieses Gerät.",
    ...
    "24-hour time. An end before the start wraps past midnight.": "Uhrzeit im 24-Stunden-Format. Ein Ende vor dem Beginn läuft über Mitternacht.",
    ...
    "Rules are active on the selected routes.": "Die Regeln sind auf den ausgewählten Routen aktiv.",
    ...
    "Routes": "Routen",
    "Hide buttons follow the setting above.": "Die Ausblenden-Schaltflächen folgen der Einstellung oben.",
    ...
    "Hide button status": "Status der Ausblenden-Schaltflächen",
    "Activates when Hide dismissed posts is on.": "Wird aktiv, wenn Verworfene Beiträge ausblenden eingeschaltet ist.",
    ...
    "X stops a playing video when you switch tabs. This resumes it when you come back. A video you paused yourself stays paused.": "X stoppt ein laufendes Video, wenn du den Tab wechselst. Dies setzt es bei deiner Rückkehr fort. Ein Video, das du selbst pausiert hast, bleibt pausiert.",
    ...
    "When X hands Aviary a playlist listing several qualities, keep only the highest. X often settles below the best available on a fast connection. This uses more data, and it can only act on playlists Aviary sees.": "Wenn X eine Playlist mit mehreren Qualitäten übergibt, nur die höchste behalten. Bei schneller Verbindung bleibt X oft unter der besten verfügbaren. Das verbraucht mehr Daten und wirkt nur auf Playlists, die Aviary zu sehen bekommt.",
    "Playback": "Wiedergabe",
    "The download preference applies to every media control.": "Die Download-Einstellung gilt für jedes Mediensteuerelement.",
    "Show download buttons": "Download-Schaltflächen anzeigen",
    "Add one Download action to each media post, plus per-asset controls.": "Fügt jedem Medienbeitrag eine Herunterladen-Aktion sowie Steuerelemente pro Datei hinzu.",
    ...
    "Original quality status": "Status der Originalqualität",
    ...
    "Maximum media downloads in flight during a batch (1-6).": "Maximale Anzahl gleichzeitig laufender Mediendownloads während eines Stapels (1–6).",
    "Download pacing": "Download-Taktung",
    "Controls the opening burst and sustained pace of batch media requests.": "Steuert den anfänglichen Burst und das anhaltende Tempo von Medienanfragen im Stapel.",
    ...
    "On-post controls": "Steuerelemente an Beiträgen",
    ...
    "Fetch media during the export action and include successful bytes with length and checksum; failed items remain retryable references.": "Lädt Medien während des Exports und fügt erfolgreiche Bytes mit Länge und Prüfsumme ein; fehlgeschlagene Elemente bleiben wiederholbare Referenzen.",
    ...
    "{jobs} jobs tracked · {queries} GraphQL IDs cached": "{jobs} Jobs verfolgt · {queries} GraphQL-IDs im Cache",
    ...
    "Destination": "Ziel",
    "Jobs": "Aufträge",
    "Show the AI button on posts": "KI-Schaltfläche an Beiträgen anzeigen",
    "Adds a button to every post that builds a Translate, Summarize, Explain or Fact-check prompt. Without an AI provider configured it copies the prompt to your clipboard; nothing is sent anywhere.": "Fügt jedem Beitrag eine Schaltfläche hinzu, die eine Anfrage zum Übersetzen, Zusammenfassen, Erklären oder Faktenprüfen erstellt. Ohne eingerichteten KI-Anbieter wird die Anfrage in die Zwischenablage kopiert; es wird nichts irgendwohin gesendet.",
    ...
    "One snippet per line. Reusable replies / templates insert from the composer toolbar.": "Ein Baustein pro Zeile. Wiederverwendbare Antworten und Vorlagen, die über die Composer-Leiste eingefügt werden.",
    "Save, search, organize, and revisit posts in a local bookmark library.": "Beiträge in einer lokalen Lesezeichenbibliothek speichern, suchen, organisieren und wiederfinden.",
    "Post tools": "Beitragswerkzeuge",
    "Writing tools": "Schreibwerkzeuge",
    "{count} entries · latest {kind} of {latestCount} @ {at}": "{count} Einträge · zuletzt {kind} mit {latestCount} am {at}",
    ...
    "Pick a ZIP exported from x.com. STORE and DEFLATE entries are supported; the source stays local while it is resumable.": "Wähle ein von x.com exportiertes ZIP. STORE- und DEFLATE-Einträge werden unterstützt; die Quelle bleibt lokal, solange der Vorgang fortgesetzt werden kann.",
    "Search captured records": "Erfasste Datensätze suchen",
    "Full-text search across the latest export collector run.": "Volltextsuche über den letzten Export-Sammlerlauf.",
    "@handle, keyword, phrase…": "@Handle, Stichwort, Ausdruck…",
    "Type to search the records captured by export runs.": "Gib einen Suchbegriff für die von Exportläufen erfassten Datensätze ein.",
    ...
    "{total} items · queued {queued} · approved {approved} · skipped {skipped}": "{total} Elemente · in Warteschlange {queued} · genehmigt {approved} · übersprungen {skipped}",
    ...
    "Refresh to list in-flight transfers; tap Cancel to abort one.": "Aktualisieren, um laufende Übertragungen aufzulisten; mit „Abbrechen“ eine abbrechen.",
    ...
    "Before sending, Aviary shows the provider, endpoint, fields, character/token estimate, retention, and budget status.": "Vor dem Senden zeigt Aviary Anbieter, Endpunkt, Felder, Zeichen-/Token-Schätzung, Aufbewahrung und Budgetstatus.",
    "AI usage today": "KI-Nutzung heute",
    "AI max request bytes": "Maximale Bytes pro KI-Anfrage",
    "Stop before sending one AI request larger than this UTF-8 body. Set 0 to block every AI request.": "Vor dem Senden stoppen, wenn der UTF-8-Textkörper einer KI-Anfrage größer ist. 0 blockiert jede KI-Anfrage.",
    "AI daily request bytes": "Tägliche Bytes für KI-Anfragen",
    ...
    "Send captured record text to the configured embedding endpoint for similarity search. The destination, fields, retention, and byte budget are shown here.": "Erfassten Datensatztext zur Ähnlichkeitssuche an den konfigurierten Embedding-Endpunkt senden. Ziel, Felder, Aufbewahrung und Bytebudget werden hier angezeigt.",
    ...
    "A request contains the model and captured record text. Vectors and bounded text stay in Aviary's local index; provider retention follows its policy.": "Eine Anfrage enthält Modell und erfassten Datensatztext. Vektoren und begrenzter Text bleiben in Aviarys lokalem Index; die Aufbewahrung des Anbieters folgt dessen Richtlinie.",
    "Embedding usage today": "Embedding-Nutzung heute",
    "Embedding max record bytes": "Maximale Bytes pro Embedding-Datensatz",
    "Stop before sending one record larger than this UTF-8 body. Set 0 to block every embedding call.": "Vor dem Senden stoppen, wenn der UTF-8-Textkörper eines Datensatzes größer ist. 0 blockiert jeden Embedding-Aufruf.",
    "Embedding daily record bytes": "Tägliche Datensatzbytes für Embeddings",
    ...
    "Before enabling, review the endpoint, captured-record fields, local retention, and daily byte budget above. After each export, embed in the background. Off by default.": "Prüfe vor dem Aktivieren oben Endpunkt, Felder erfasster Datensätze, lokale Aufbewahrung und tägliches Bytebudget. Nach jedem Export werden Embeddings im Hintergrund erstellt. Standardmäßig aus.",
    ...
    "Vector similarity over captured records. Embeddings run on demand.": "Vektorsimilarität über erfasste Datensätze. Embeddings werden bei Bedarf ausgeführt.",
    ...
    "Clear AI and embedding usage": "KI- und Embedding-Nutzung löschen",
    "Forget local request counters only. This does not remove the semantic index or provider credentials.": "Nur lokale Anfragezähler vergessen. Der semantische Index und Anbieterzugangsdaten bleiben erhalten.",
    "on": "ein",
    "off": "aus",
    "configured": "konfiguriert",
    "missing endpoint": "Endpunkt fehlt",
    "missing credentials": "Zugangsdaten fehlen",
    "missing key/model": "Schlüssel/Modell fehlt",
    "indexed": "indexiert",
    "{name}: {state} · {config}": "{name} — {state} · {config}",
    "{name}: {state} · {count} {indexed}": "{name} — {state} · {count} {indexed}",
    ...
    "Stop after the current collection and roll back anything already written.": "Nach der aktuellen Sammlung stoppen und alle bisherigen Schreibvorgänge zurücksetzen.",
    "Validate the backup and show the same conflicts without writing or removing any local data.": "Die Sicherung prüfen und dieselben Konflikte anzeigen, ohne lokale Daten zu schreiben oder zu löschen.",
    "Apply the selected profile collections. A failed write rolls back the collections already changed.": "Die ausgewählten Profilsammlungen anwenden. Bei einem fehlgeschlagenen Schreibvorgang werden bereits geänderte Sammlungen zurückgesetzt.",
    ...
    "Restores Aviary's defaults: ad-free mode stays on and every other visual or behavior control returns to off. Saved posts, notes, bookmarks, and download history are kept.": "Stellt Aviarys Standardwerte wieder her: Der werbefreie Modus bleibt aktiv, alle anderen visuellen oder Verhaltenssteuerungen werden deaktiviert. Gespeicherte Beiträge, Notizen, Lesezeichen und der Download-Verlauf bleiben erhalten.",
    ...
    "Import": "Importieren",
    "Export full library backup": "Vollständige Bibliothekssicherung exportieren",
    "Downloads one versioned JSON backup of this profile's local collections. Credentials are excluded by default; restoring keeps the credentials already saved here.": "Lädt eine versionierte JSON-Sicherung der lokalen Sammlungen dieses Profils herunter. Zugangsdaten werden standardmäßig ausgeschlossen; beim Wiederherstellen bleiben die hier gespeicherten Zugangsdaten erhalten.",
    "Choose a library backup": "Bibliothekssicherung auswählen",
    "Select a JSON backup to inspect its versions, counts, conflicts, and checksum before changing local data.": "Wähle eine JSON-Sicherung aus, um Versionen, Anzahlen, Konflikte und Prüfsumme vor einer Änderung lokaler Daten zu prüfen.",
    ...
    "Monitor selector health": "Selektorstatus überwachen",
    "Check the current X surface for required and fallback anchors. Turn this off when you do not want selector diagnostics.": "Prüft die aktuelle X-Oberfläche auf erforderliche und alternative Anker. Deaktivieren Sie dies, wenn Sie keine Selektordiagnose wünschen.",
    ...
    "Save or revert your changes before leaving this section.": "Speichere oder verwirf deine Änderungen, bevor du diesen Abschnitt verlässt.",
    "Action failed.": "Aktion fehlgeschlagen.",
    "Saving...": "Wird gespeichert...",
    "Fix invalid values before saving.": "Korrigiere ungültige Werte vor dem Speichern.",
    ...
    "Selector health monitoring on": "Überwachung des Selektorstatus aktiviert",
    "Selector health monitoring off": "Überwachung des Selektorstatus deaktiviert",
    "Saved warnings cleared.": "Gespeicherte Warnungen gelöscht.",
    "Could not clear saved warnings.": "Gespeicherte Warnungen konnten nicht gelöscht werden.",
    "Ad observations reset.": "Werbebeobachtungen zurückgesetzt.",
    "Could not reset ad observations.": "Werbebeobachtungen konnten nicht zurückgesetzt werden.",
    ...
    "Posted {posts} to Bluesky.{url}": "{posts} auf Bluesky veröffentlicht.{url}",
    "Bluesky failed: {error}": "Bluesky fehlgeschlagen: {error}",
    "Bluesky crosspost failed.": "Bluesky-Crosspost fehlgeschlagen.",
    "Posted {posts} to Mastodon.{url}": "{posts} auf Mastodon veröffentlicht.{url}",
    ...
    "AI daily budget saved": "Tägliches KI-Budget gespeichert",
    ...
    "Embedding daily budget saved": "Tägliches Embedding-Budget gespeichert",
    ...
    "Embedding stopped at the budget ({blocked} records were not sent).": "Embeddings am Budget gestoppt ({blocked} Datensätze wurden nicht gesendet).",
    "Indexed: +{added} new · skipped {skipped} · errors {errors} · total {total}{trimmed}.": "Indexiert: +{added} neu · {skipped} übersprungen · Fehler {errors} · gesamt {total}{trimmed}.",
    "Embedding failed.": "Embedding fehlgeschlagen.",
    "Semantic index cleared": "Semantischer Index gelöscht",
    "Could not clear semantic index.": "Semantischer Index konnte nicht gelöscht werden.",
    "AI and embedding usage cleared": "KI- und Embedding-Nutzung gelöscht",
    "Could not clear AI and embedding usage.": "KI- und Embedding-Nutzung konnte nicht gelöscht werden.",
    "Preferences reset. Ad-free mode is on.": "Einstellungen zurückgesetzt. Der werbefreie Modus ist aktiv.",
    "Could not reset settings.": "Einstellungen konnten nicht zurückgesetzt werden.",
    ...
    "Could not export full library backup.": "Die vollständige Bibliothekssicherung konnte nicht exportiert werden.",
    "Reading library backup…": "Bibliothekssicherung wird gelesen…",
    "Backup loaded: {collections} collections, {conflicts} changes.": "Sicherung geladen: {collections} Sammlungen, {conflicts} Änderungen.",
    ...
    "Dry-run complete. No local data changed.": "Probelauf abgeschlossen. Lokale Daten wurden nicht geändert.",
    ...
    "Restore cancelled; local data was rolled back.": "Wiederherstellung abgebrochen; lokale Daten wurden zurückgesetzt.",
    ...
    "Captured {count} followers for @{handle}.": "{count} Follower für @{handle} erfasst.",
    "No UserCell rows found.": "Keine UserCell-Zeilen gefunden.",
    "Snapshot failed.": "Momentaufnahme fehlgeschlagen.",
    "Captured {count} following for @{handle}.": "{count} abonnierte Konten für @{handle} erfasst.",
    ...
    "Imported {records} records. Warnings: {warnings}; errors: {errors}. Files: {recognized} recognized, {skipped} skipped, {malformed} malformed.": "{records} Datensätze importiert. Warnungen: {warnings}; Fehler: {errors}. Dateien: {recognized} erkannt, {skipped} übersprungen, {malformed} fehlerhaft.",
    ...
    "Enqueued {added} items ({protected} protected skipped).": "{added} Elemente eingereiht ({protected} geschützte übersprungen).",
    ...
    "Bookmarks cleared.": "Lesezeichen gelöscht.",
    "Could not clear bookmarks.": "Lesezeichen konnten nicht gelöscht werden.",
    "AI button on": "KI-Schaltfläche an",
    "AI button off": "KI-Schaltfläche aus",
    ...
    "Exported {records} records across {files} ZIPs → {filename}": "{records} Datensätze in {files} ZIPs exportiert → {filename}",
    "Exported {records} record → {filename}": "{records} Datensatz exportiert → {filename}",
    "Exported {records} records → {filename}": "{records} Datensätze exportiert → {filename}",
    ...
    "WARC downloaded ({records} records).": "WARC heruntergeladen ({records} Datensätze).",
    "WARC export failed.": "WARC-Export fehlgeschlagen.",
    "Copied {records} records to clipboard.": "{records} Datensätze in die Zwischenablage kopiert.",
    "Exported {records} records to {target}.": "{records} Datensätze nach {target} exportiert.",
    ...
    "Concurrent download limit saved": "Limit für gleichzeitige Downloads gespeichert",
    ...
    "No failed media jobs to retry.": "Keine fehlgeschlagenen Medienaufträge zum Wiederholen.",
    ...
    "Count preference saved": "Zähler-Einstellung gespeichert",
    "Tab title badge hidden": "Tab-Zähler ausgeblendet",
    "Tab title badge shown": "Tab-Zähler sichtbar",
    ...
    "Video keeps playing": "Video läuft weiter",
    ...
    "Seen-post dimming on": "Abblenden gesehener Beiträge an",
    "Seen-post dimming off": "Abblenden gesehener Beiträge aus",
    "Seen posts forgotten.": "Gesehene Beiträge vergessen.",
    "Could not clear seen posts.": "Gesehene Beiträge konnten nicht gelöscht werden.",
    ...
    "Cleared {removed} hidden post.": "{removed} ausgeblendeter Beitrag gelöscht.",
    "Cleared {removed} hidden posts.": "{removed} ausgeblendete Beiträge gelöscht.",
    ...
    "Try a shorter word, or pick a section on the left.": "Versuche ein kürzeres Wort oder wähle links einen Bereich.",
    ...
    "Unavailable in this browser.": "In diesem Browser nicht verfügbar.",
    "Selector matches": "Selektor-Treffer",
    "Missing required surfaces": "Erforderliche Oberflächen fehlen",
    "Optional surfaces missing": "Optionale Oberflächen fehlen",
    "Fallback selectors in use": "Ersatzselektoren in Verwendung",
    "Affected features": "Betroffene Funktionen",
    "Last selector transition": "Letzter Selektorübergang",
    ...
    "Open a profile's followers or following list, then use Capture snapshot to record it.": "Öffne die Follower- oder Gefolgt-Liste eines Profils und nutze „Momentaufnahme erfassen“, um sie festzuhalten.",
    "No captured records match “{query}”.": "Keine erfassten Datensätze entsprechen „{query}“.",
    "Search all local collections": "Alle lokalen Sammlungen durchsuchen",
    "Search posts, likes, bookmarks, notes, tags, folders, and snapshots with filters.": "Beiträge, Likes, Lesezeichen, Notizen, Tags, Ordner und Momentaufnahmen mit Filtern durchsuchen.",
    ...
    "Search saved posts by text, handle, tags, folder, or ID.": "Gespeicherte Beiträge nach Text, Handle, Tags, Ordner oder ID suchen.",
    ...
    "Remove": "Entfernen",
    "Add one below as handle: note. Notes appear beside that account's posts.": "Füge unten eine im Format Name: Notiz hinzu. Notizen erscheinen neben den Beiträgen dieses Kontos.",
    "Turn Capture on, scroll a timeline, then export. Jobs and their records appear here.": "Schalte die Erfassung ein, scrolle durch eine Timeline und exportiere dann. Aufträge und ihre Datensätze erscheinen hier.",
    "Formerly observed markers are no longer detected: {markers}.": "Zuvor beobachtete Marker werden nicht mehr erkannt: {markers}.",
    "X is in {language}, which Aviary has no ad labels for. Sponsored posts are not suppressed by label here.": "X läuft auf {language}, einer Sprache, für die Aviary keine Werbekennzeichnungen hat. Gesponserte Beiträge werden hier nicht über die Kennzeichnung ausgeblendet.",
    "gid {gid} · {status}": "GID {gid} · {status}",
    "{count} entries": "{count} Einträge",
    "{posts} posts · {likes} likes · {messages} direct messages (kept out of public search) · {media} media refs · {followers} followers · {following} following · {lists} lists": "{posts} Beiträge · {likes} Likes · {messages} Direktnachrichten (nicht in der öffentlichen Suche) · {media} Medienverweise · {followers} Follower · {following} gefolgt · {lists} Listen",
    "{status} · {filename} · {records} records · {files} files · {warnings} warnings": "{status} · {filename} · {records} Datensätze · {files} Dateien · {warnings} Warnungen",
    "{saved} saved · {due} due · {tags} tags · {folders} folders": "{saved} gespeichert · {due} fällig · {tags} Tags · {folders} Ordner",
    "{status} · {records} records · {surface}": "{status} · {records} Datensätze · {surface}",
    ...
    "Clear the bounded local marker history and its drift warning. No post text, handles, URLs, or response bodies are stored here.": "Löscht den begrenzten lokalen Markerverlauf und seine Abweichungswarnung. Beitragstexte, Handles, URLs oder Antwortinhalte werden hier nicht gespeichert.",
    ...
    "Ad labels for this language": "Werbekennzeichnungen für diese Sprache",
    "Saved warnings": "Gespeicherte Warnungen",
    "Clear saved warnings": "Gespeicherte Warnungen löschen",
    "Reset ad observations": "Werbebeobachtungen zurücksetzen",
    ...
    "Collection changes": "Änderungen an Sammlungen",
    ...
    "Forget seen posts": "Gesehene Beiträge vergessen",
    ...
    "Review external AI request": "Externe KI-Anfrage prüfen",
    "Nothing is sent until you choose Send request.": "Es wird nichts gesendet, bis du Anfrage senden auswählst.",
    "unlimited": "unbegrenzt",
    "Aviary stores usage counters only; the provider's retention follows its policy.": "Aviary speichert nur Nutzungszähler; die Aufbewahrung des Anbieters richtet sich nach dessen Richtlinie.",
    ...
    "Sponsored posts, promoted trends and pre-rolls are hidden.": "Gesponserte Beiträge, beworbene Trends und Pre-Rolls sind ausgeblendet.",
    "Photos and videos get a save control that only acts when you click it.": "Fotos und Videos erhalten eine Speichern-Schaltfläche, die erst auf deinen Klick hin etwas tut.",
    "Open Aviary from the last row of X's left navigation to change any of it.": "Öffne Aviary über die letzte Zeile in X' linker Navigation, um daran etwas zu ändern.",
    "Got it": "Verstanden",
    "Hide trends, row borders and engagement counts, dim premium posts, strip t.co, dense + dim theme.": "Blendet Trends, Zeilenrahmen und Interaktionszahlen aus, dimmt Premium-Beiträge, bereinigt t.co, dichtes und gedimmtes Design.",
    "Media Archivist": "Medienarchiv",
    "Original-quality downloads, deterministic filenames, dedup history, stacked media.": "Downloads in Originalqualität, deterministische Dateinamen, Verlauf ohne Duplikate, gestapelte Medien.",
    ...
    "Outside your reading hours": "Außerhalb deiner Lesezeit",
    "Aviary is covering the timeline until your next window. Nothing is blocked and nothing left this device.": "Aviary deckt die Timeline bis zu deinem nächsten Zeitfenster ab. Nichts wird blockiert, und nichts hat dieses Gerät verlassen.",
    "Let me through for five minutes": "Lass mich fünf Minuten durch",
    ...
    "Note": "Notiz",
    "Tag": "Markierung",
    "Download access was not granted. Open Aviary Options to enable browser downloads.": "Der Download-Zugriff wurde nicht erteilt. Öffne die Aviary-Optionen, um Browser-Downloads zu aktivieren.",
    "Media download failed. Try the on-post button again.": "Medien-Download fehlgeschlagen. Versuche es erneut über die Schaltfläche am Beitrag.",
    "Right-click an image or video first, then choose Aviary download.": "Klicke zuerst mit der rechten Maustaste auf ein Bild oder Video und wähle dann den Aviary-Download.",
    ...
    "This image is not available to download.": "Dieses Bild steht nicht zum Download zur Verfügung.",
    ...
    "granted": "erteilt",
    "optional": "freiwillig",
    "All optional. You're in control.": "Alles ist optional. Du behältst die Kontrolle.",
    "Save media to disk": "Medien auf die Festplatte speichern",
    "checking…": "wird geprüft…",
    "Lets the Save and Thumb buttons write files through the browser's download manager, with your filename template and duplicate history. Without it the browser opens media in a tab instead of saving it.": "Lässt die Schaltflächen Speichern und Vorschaubild Dateien über den Download-Manager des Browsers schreiben, mit deiner Namensvorlage und dem Duplikatverlauf. Ohne sie öffnet der Browser Medien in einem Tab, statt sie zu speichern.",
    "Grant download access": "Download-Zugriff erteilen",
    "Revoke": "Widerrufen",
    "Read media hosts directly": "Medien-Hosts direkt lesen",
    "Adds the media hosts so large files can be fetched without a page round-trip. Optional — media buttons work without it.": "Fügt die Medien-Hosts hinzu, damit große Dateien ohne Umweg über die Seite geladen werden. Optional — die Medienschaltflächen funktionieren auch ohne.",
    ...
    "Request dismissed — nothing changed.": "Anfrage verworfen — nichts geändert.",
    "Revoked.": "Widerrufen.",
    "Nothing to revoke.": "Nichts zu widerrufen.",
    "not granted": "nicht erteilt",
    "Granted. Media saves through the browser now.": "Erteilt. Medien werden jetzt über den Browser gespeichert.",
    "Granted. Aviary can read full-size media directly for exports now.": "Erteilt. Aviary kann Medien jetzt in voller Größe für Exporte lesen.",
    "Aviary archive": "Aviary-Archiv",
    "Local archive viewer — remote references are never fetched automatically.": "Lokaler Archiv-Viewer — Remote-Referenzen werden niemals automatisch abgerufen.",
    "Search records": "Einträge durchsuchen",
    "Media status": "Medienstatus",
    "All media": "Alle Medien",
    "Captured bytes": "Erfasste Bytes",
    "Remote reference": "Remote-Referenz",
    "Missing": "Fehlt",
    "Sort": "Sortieren",
    "Newest first": "Neueste zuerst",
    "Oldest first": "Älteste zuerst",
    "Handle": "Handle",
    "Thread view": "Thread-Ansicht",
    "records": "Einträge",
    "shown": "angezeigt",
    ...
    "Stop before sending one AI request larger than this UTF-8 body. Use 0 for no per-request bound.": "Vor dem Senden stoppen, wenn der UTF-8-Textkörper einer KI-Anfrage größer ist. 0 hebt die Grenze pro Anfrage auf.",
    ...
    "Stop before sending one record larger than this UTF-8 body. Use 0 for no per-record bound.": "Vor dem Senden stoppen, wenn ein Datensatz größer als dieser UTF-8-Körper ist. 0 hebt die Grenze pro Datensatz auf.",
    ...
    "Only applies while Ad-free mode is on. Aviary refuses X's separate promoted-content logging request, the one ad request that can be separated from the timeline itself. Turn this off if X complains about an ad blocker: sponsored posts stay hidden and Aviary stops refusing any request at all.": "Gilt nur, solange der werbefreie Modus aktiv ist. Aviary lehnt X' separate Protokollanfrage für beworbene Inhalte ab — die einzige Werbeanfrage, die sich von der Timeline selbst trennen lässt. Schalte dies aus, wenn X einen Werbeblocker moniert: Gesponserte Beiträge bleiben ausgeblendet, und Aviary lehnt überhaupt keine Anfrage mehr ab.",
    "Always play video at the highest quality": "Videos immer in höchster Qualität abspielen",
    "X picks a video quality to suit your connection, and on a fast connection it often settles below the best one available. This pins every video to its highest rendition. It uses more data.": "X wählt eine Videoqualität passend zu deiner Verbindung und bleibt bei schnellen Verbindungen oft unter der bestmöglichen. Dies legt jedes Video auf seine höchste Auflösung fest. Es verbraucht mehr Daten.",
    "Best video quality on": "Beste Videoqualität an",
    "Video quality left to X": "Videoqualität bleibt X überlassen",
    "Hide reply, repost, like, and view numbers. The controls still work and screen readers still announce the totals.": "Blendet die Zahlen für Antworten, Reposts, Likes und Aufrufe aus. Die Bedienelemente funktionieren weiter, und Screenreader nennen die Summen weiterhin.",
    "Original quality is applied when download controls are enabled.": "Originalqualität wird angewendet, wenn die Download-Steuerelemente aktiviert sind.",
    ...
    "Reset everything to plain X": "Alles auf das pure X zurücksetzen",
    "Puts every setting back to its default, which is to change nothing about X at all. Your saved posts, notes, bookmarks and download history are kept — this only resets preferences.": "Setzt jede Einstellung auf ihren Standard zurück — und der ist, an X überhaupt nichts zu ändern. Gespeicherte Beiträge, Notizen, Lesezeichen und der Download-Verlauf bleiben erhalten; zurückgesetzt werden nur die Einstellungen.",
    "Everything reset. X is untouched again.": "Alles zurückgesetzt. X ist wieder unberührt.",
    ...
    "Photo and video display saved": "Einstellung für Fotos und Videos gespeichert",
  ...
  ja: {
    ...
    "Only applies while Ad-free mode is on. Aviary refuses exactly one request — X's separate promoted-content logging call — and nothing else, including the checks X uses to notice an ad blocker. Turn this off if X complains anyway: sponsored posts stay hidden and Aviary stops refusing any request at all.": "広告非表示モードが有効な間のみ適用されます。Aviary が拒否するのは X のプロモーションコンテンツ記録リクエストの 1 件だけで、X が広告ブロッカーを検出するために使う確認リクエストを含め、ほかは一切拒否しません。それでも X が警告を出す場合はこれをオフにしてください。プロモーション投稿は引き続き非表示のまま、Aviary はどのリクエストも拒否しなくなります。",
    ...
    "{jobs} jobs tracked · {queries} GraphQL IDs cached": "{jobs}件のジョブを追跡 · GraphQL ID {queries}件をキャッシュ",
    ...
    "One snippet per line. Reusable replies / templates insert from the composer toolbar.": "1行に1つ。作成画面のツールバーから挿入できる再利用可能な返信・テンプレート。",
    "Save, search, organize, and revisit posts in a local bookmark library.": "投稿をローカルのブックマークライブラリに保存し、検索、整理、再訪できます。",
    "Post tools": "投稿ツール",
    "Writing tools": "執筆ツール",
    "{count} entries · latest {kind} of {latestCount} @ {at}": "{count}件 · 最新: {kind} {latestCount}件 @ {at}",
    ...
    "{total} items · queued {queued} · approved {approved} · skipped {skipped}": "{total}件 · キュー {queued} · 承認済み {approved} · スキップ {skipped}",
    ...
    "Saving...": "保存中...",
    "Fix invalid values before saving.": "保存する前に無効な値を修正してください。",
    ...
    "Indexed: +{added} new · skipped {skipped} · errors {errors} · total {total}{trimmed}.": "インデックス: 新規 +{added}件 · スキップ {skipped}件 · エラー {errors}件 · 合計 {total}件{trimmed}。",
    ...
    "Exported {records} records across {files} ZIPs → {filename}": "{records}件を{files}個のZIPに書き出しました → {filename}",
    "Exported {records} record → {filename}": "{records}件を書き出しました → {filename}",
    "Exported {records} records → {filename}": "{records}件を書き出しました → {filename}",
    ...
    "Copied {records} records to clipboard.": "{records}件をクリップボードにコピーしました。",
    "Exported {records} records to {target}.": "{records}件を{target}に書き出しました。",
    ...
    "gid {gid} · {status}": "識別子 {gid} · {status}",
    "{count} entries": "{count}件",
    "{posts} posts · {likes} likes · {messages} direct messages (kept out of public search) · {media} media refs · {followers} followers · {following} following · {lists} lists": "投稿{posts}件 · いいね{likes}件 · ダイレクトメッセージ{messages}件（公開検索対象外） · メディア参照{media}件 · フォロワー{followers}件 · フォロー中{following}件 · リスト{lists}件",
    "{status} · {filename} · {records} records · {files} files · {warnings} warnings": "{status} · {filename} · {records}件 · {files}ファイル · 警告{warnings}件",
    "{saved} saved · {due} due · {tags} tags · {folders} folders": "保存済み{saved}件 · 期限{due}件 · タグ{tags}件 · フォルダー{folders}件",
    "{status} · {records} records · {surface}": "{status} · {records}件 · {surface}",
    ...
    "Resume archive import": "アーカイブのインポートを再開",
    "Cancel archive import": "アーカイブのインポートをキャンセル",
    ...
    "Cancel export job": "エクスポートジョブをキャンセル",
    ...
    "Aviary archive": "Aviary アーカイブ",
    "Local archive viewer — remote references are never fetched automatically.": "ローカルアーカイブビューアー — リモート参照は自動取得されません。",
    "Search records": "レコードを検索",
    "Media status": "メディア状態",
    "All media": "すべてのメディア",
    "Captured bytes": "キャプチャ済みバイト",
    "Remote reference": "リモート参照",
    "Missing": "欠落",
    "Sort": "並べ替え",
    "Newest first": "新しい順",
    "Oldest first": "古い順",
    ...
    "records": "件",
    "shown": "表示",
    "No matching records.": "一致するレコードはありません。",
    "source": "ソース",
    "bytes": "バイト",
    "SHA-256": "SHA-256",
  ...
  ko: {
    ...
    "Language": "언어",
    "Theme": "테마",
    "Noir adds Aviary's premium cyan-violet skin; Off leaves X's own styling untouched.": "Noir는 Aviary의 프리미엄 시안·바이올렛 스타일을 적용합니다. 끄면 X의 기본 스타일을 그대로 둡니다.",
    ...
    "Only applies while Ad-free mode is on. Aviary refuses exactly one request — X's separate promoted-content logging call — and nothing else, including the checks X uses to notice an ad blocker. Turn this off if X complains anyway: sponsored posts stay hidden and Aviary stops refusing any request at all.": "광고 없는 모드가 켜져 있을 때만 적용됩니다. Aviary는 X의 프로모션 콘텐츠 기록 요청 단 하나만 거부하며, X가 광고 차단기를 감지하는 데 사용하는 확인 요청을 포함해 다른 어떤 요청도 거부하지 않습니다. 그래도 X가 경고를 표시하면 이 옵션을 끄세요. 프로모션 게시물은 계속 숨겨지고 Aviary는 어떤 요청도 거부하지 않게 됩니다.",
    ...
    "{jobs} jobs tracked · {queries} GraphQL IDs cached": "{jobs}개 작업 추적 · GraphQL ID {queries}개 캐시됨",
    ...
    "Adds a button to every post that builds a Translate, Summarize, Explain or Fact-check prompt. Without an AI provider configured it copies the prompt to your clipboard; nothing is sent anywhere.": "번역·요약·설명·사실 확인 프롬프트를 만들어 주는 버튼을 모든 게시물에 추가합니다. AI 공급자를 설정하지 않았다면 프롬프트를 클립보드에 복사할 뿐, 아무것도 전송하지 않습니다.",
    ...
    "One snippet per line. Reusable replies / templates insert from the composer toolbar.": "한 줄에 하나씩. 작성기 도구 모음에서 삽입할 수 있는 재사용 가능한 답글·템플릿입니다.",
    ...
    "{count} entries · latest {kind} of {latestCount} @ {at}": "{count}개 · 최근 {kind} {latestCount}개 @ {at}",
    ...
    "{total} items · queued {queued} · approved {approved} · skipped {skipped}": "{total}개 · 대기 {queued} · 승인 {approved} · 건너뜀 {skipped}",
    ...
    "Stops the tracking pings X sends as you scroll, click and pause. Only the analytics endpoints are refused — timeline, media and login traffic is untouched.": "스크롤하거나 클릭하거나 일시정지할 때 X가 보내는 추적 신호를 막습니다. 분석 엔드포인트만 거부하며 타임라인·미디어·로그인 트래픽은 건드리지 않습니다.",
    ...
    "Saving...": "저장 중...",
    "Fix invalid values before saving.": "저장하기 전에 잘못된 값을 수정하세요.",
    ...
    "Indexed: +{added} new · skipped {skipped} · errors {errors} · total {total}{trimmed}.": "색인됨: 신규 +{added}개 · 건너뜀 {skipped}개 · 오류 {errors}개 · 총 {total}개{trimmed}.",
    ...
    "Exported {records} records across {files} ZIPs → {filename}": "{records}개 레코드를 {files}개 ZIP으로 내보냄 → {filename}",
    "Exported {records} record → {filename}": "{records}개 레코드 내보냄 → {filename}",
    "Exported {records} records → {filename}": "{records}개 레코드 내보냄 → {filename}",
    ...
    "Copied {records} records to clipboard.": "{records}개 레코드를 클립보드에 복사함.",
    "Exported {records} records to {target}.": "{records}개 레코드를 {target}(으)로 내보냄.",
    ...
    "gid {gid} · {status}": "식별자 {gid} · {status}",
    "{count} entries": "{count}개 항목",
    "{posts} posts · {likes} likes · {messages} direct messages (kept out of public search) · {media} media refs · {followers} followers · {following} following · {lists} lists": "게시물 {posts}개 · 좋아요 {likes}개 · 쪽지 {messages}개(공개 검색 제외) · 미디어 참조 {media}개 · 팔로워 {followers}명 · 팔로잉 {following}명 · 목록 {lists}개",
    "{status} · {filename} · {records} records · {files} files · {warnings} warnings": "{status} · {filename} · 레코드 {records}개 · 파일 {files}개 · 경고 {warnings}개",
    "{saved} saved · {due} due · {tags} tags · {folders} folders": "저장 {saved}개 · 예정 {due}개 · 태그 {tags}개 · 폴더 {folders}개",
    "{status} · {records} records · {surface}": "{status} · 레코드 {records}개 · {surface}",
    ...
    "Resume archive import": "아카이브 가져오기 재개",
    "Cancel archive import": "아카이브 가져오기 취소",
    ...
    "Got it": "확인",
    "Hide trends, row borders and engagement counts, dim premium posts, strip t.co, dense + dim theme.": "트렌드·행 경계선·반응 수를 숨기고, 프리미엄 게시물을 흐리게 하며, t.co를 정리하는 조밀하고 어두운 테마.",
    ...
    "checking…": "확인 중…",
    "Lets the Save and Thumb buttons write files through the browser's download manager, with your filename template and duplicate history. Without it the browser opens media in a tab instead of saving it.": "저장·썸네일 버튼이 브라우저 다운로드 관리자를 통해 파일을 저장할 수 있게 합니다(파일 이름 템플릿과 중복 기록 포함). 허용하지 않으면 브라우저가 저장 대신 새 탭에서 엽니다.",
    ...
    "Aviary archive": "Aviary 아카이브",
    "Local archive viewer — remote references are never fetched automatically.": "로컬 아카이브 뷰어 — 원격 참조를 자동으로 가져오지 않습니다.",
    "Search records": "레코드 검색",
    "Media status": "미디어 상태",
    "All media": "모든 미디어",
    "Captured bytes": "캡처된 바이트",
    "Remote reference": "원격 참조",
    "Missing": "누락됨",
    "Sort": "정렬",
    "Newest first": "최신순",
    "Oldest first": "오래된 순",
    ...
    "Hide reply, repost, like, and view numbers. The controls still work and screen readers still announce the totals.": "답글·재게시·마음에 들어요·조회 수를 숨깁니다. 컨트롤은 그대로 작동하고 스크린 리더는 합계를 계속 읽어 줍니다.",
    ...
    "Puts every setting back to its default, which is to change nothing about X at all. Your saved posts, notes, bookmarks and download history are kept — this only resets preferences.": "모든 설정을 기본값으로 되돌립니다. 기본값은 X를 전혀 바꾸지 않는 상태입니다. 저장한 게시물·메모·북마크·다운로드 기록은 그대로 유지되며 설정만 초기화됩니다.",
  ...
  ar: {
    ...
    "Applies while Hide engagement counts is on.": "يُطبَّق أثناء تفعيل «إخفاء أعداد التفاعل».",
    "Hide repost counts": "إخفاء عدد إعادات النشر",
    "Hide like counts": "إخفاء عدد الإعجابات",
    "Hide view counts": "إخفاء عدد المشاهدات",
    "Applies while Hide engagement counts is on. The view total lives in an analytics link, not an action button.": "يُطبَّق أثناء تفعيل «إخفاء أعداد التفاعل». يوجد إجمالي المشاهدات داخل رابط التحليلات وليس في زر إجراء.",
    ...
    "Only applies while Ad-free mode is on. Aviary refuses exactly one request — X's separate promoted-content logging call — and nothing else, including the checks X uses to notice an ad blocker. Turn this off if X complains anyway: sponsored posts stay hidden and Aviary stops refusing any request at all.": "ينطبق هذا فقط أثناء تفعيل وضع بلا إعلانات. يرفض Aviary طلبًا واحدًا فقط — طلب تسجيل المحتوى المموّل الخاص بمنصة X — ولا يرفض أي طلب آخر، بما في ذلك الفحوصات التي تستخدمها X لاكتشاف مانع الإعلانات. أوقف هذا الخيار إذا اشتكت X رغم ذلك: تبقى المنشورات المموّلة مخفية ويتوقف Aviary عن رفض أي طلب على الإطلاق.",
    ...
    "Remove Who to follow cards without hiding the rest of the sidebar.": "يزيل بطاقات «من تتابع» من دون إخفاء بقية الشريط الجانبي.",
    "Hide home composer": "إخفاء محرر الصفحة الرئيسية",
    "Remove the quick-post composer from Home. The Post button still opens it when needed.": "يزيل محرر النشر السريع من الصفحة الرئيسية. يظل زر «نشر» متاحًا لفتحه عند الحاجة.",
    ...
    "{jobs} jobs tracked · {queries} GraphQL IDs cached": "تم تتبع {jobs} من المهام · تم تخزين {queries} من معرّفات GraphQL مؤقتًا",
    ...
    "One snippet per line. Reusable replies / templates insert from the composer toolbar.": "مقتطف واحد في كل سطر. ردود وقوالب قابلة لإعادة الاستخدام تُدرج من شريط أدوات المحرر.",
    ...
    "{count} entries · latest {kind} of {latestCount} @ {at}": "{count} من الإدخالات · الأحدث {kind} وعدده {latestCount} في {at}",
    ...
    "{total} items · queued {queued} · approved {approved} · skipped {skipped}": "{total} من العناصر · في الانتظار {queued} · معتمدة {approved} · متخطاة {skipped}",
    ...
    "Refresh to list in-flight transfers; tap Cancel to abort one.": "حدّث لعرض عمليات النقل الجارية؛ اضغط «إلغاء» لإيقاف إحداها.",
    "Refresh": "تحديث",
    ...
    "Saving...": "جارٍ الحفظ...",
    "Fix invalid values before saving.": "صحّح القيم غير الصالحة قبل الحفظ.",
    ...
    "Indexed: +{added} new · skipped {skipped} · errors {errors} · total {total}{trimmed}.": "الفهرسة: جديد +{added} · متخطى {skipped} · أخطاء {errors} · الإجمالي {total}{trimmed}.",
    ...
    "Exported {records} records across {files} ZIPs → {filename}": "تم تصدير {records} من السجلات في {files} من ملفات ZIP ← {filename}",
    "Exported {records} record → {filename}": "تم تصدير سجل واحد ({records}) ← {filename}",
    "Exported {records} records → {filename}": "تم تصدير {records} من السجلات ← {filename}",
    ...
    "Copied {records} records to clipboard.": "تم نسخ {records} من السجلات إلى الحافظة.",
    "Exported {records} records to {target}.": "تم تصدير {records} من السجلات إلى {target}.",
    ...
    "Open a profile's followers or following list, then use Capture snapshot to record it.": "افتح قائمة المتابِعين أو المتابَعين لأحد الملفات الشخصية، ثم استخدم «التقاط لقطة» لتسجيلها.",
    "No captured records match “{query}”.": "لا توجد سجلات ملتقطة تطابق «{query}».",
    ...
    "Nothing saved yet. Use Save locally on any post to keep a copy here.": "لم يُحفظ شيء بعد. استخدم «حفظ محليًا» على أي منشور للاحتفاظ بنسخة هنا.",
    ...
    "gid {gid} · {status}": "المعرّف {gid} · {status}",
    "{count} entries": "{count} من الإدخالات",
    "{posts} posts · {likes} likes · {messages} direct messages (kept out of public search) · {media} media refs · {followers} followers · {following} following · {lists} lists": "{posts} من المنشورات · {likes} من الإعجابات · {messages} من الرسائل المباشرة (خارج البحث العام) · {media} من مراجع الوسائط · {followers} من المتابعين · {following} ممن تتابعهم · {lists} من القوائم",
    "{status} · {filename} · {records} records · {files} files · {warnings} warnings": "{status} · {filename} · {records} من السجلات · {files} من الملفات · {warnings} من التحذيرات",
    "{saved} saved · {due} due · {tags} tags · {folders} folders": "{saved} محفوظة · {due} مستحقة · {tags} من الوسوم · {folders} من المجلدات",
    "{status} · {records} records · {surface}": "{status} · {records} من السجلات · {surface}",
    ...
    "Retry {filename}.": "إعادة محاولة {filename}.",
    ...
    "Resume archive import": "استئناف استيراد الأرشيف",
    "Cancel archive import": "إلغاء استيراد الأرشيف",
    ...
    "Cancel export job": "إلغاء مهمة التصدير",
    ...
    "Aviary archive": "أرشيف Aviary",
    "Local archive viewer — remote references are never fetched automatically.": "عارض أرشيف محلي — لا يتم جلب المراجع البعيدة تلقائياً.",
    "Search records": "البحث في السجلات",
    "Media status": "حالة الوسائط",
    "All media": "كل الوسائط",
    "Captured bytes": "البايتات الملتقطة",
    "Remote reference": "مرجع بعيد",
    "Missing": "مفقود",
    "Sort": "الترتيب",
    "Newest first": "الأحدث أولاً",
    "Oldest first": "الأقدم أولاً",
    "Handle": "المعرّف",
    "Thread view": "عرض سلاسل المحادثة",
    "records": "سجلات",
    "shown": "معروضة",
    ...
    "bytes": "بايت",
    "SHA-256": "SHA-256",
    "Open source URL": "فتح عنوان المصدر",
    "posts": "منشورات",
  ...
  he: {
    ...
    "Only applies while Ad-free mode is on. Aviary refuses exactly one request — X's separate promoted-content logging call — and nothing else, including the checks X uses to notice an ad blocker. Turn this off if X complains anyway: sponsored posts stay hidden and Aviary stops refusing any request at all.": "חל רק כאשר מצב ללא פרסומות פעיל. Aviary דוחה בקשה אחת בלבד — בקשת רישום התוכן הממומן של X — ולא שום בקשה אחרת, כולל הבדיקות ש-X משתמשת בהן כדי לזהות חוסם פרסומות. כבה זאת אם X מתלוננת בכל זאת: פוסטים ממומנים יישארו מוסתרים ו-Aviary יפסיק לדחות בקשות כלשהן.",
    ...
    "{jobs} jobs tracked · {queries} GraphQL IDs cached": "{jobs} משימות במעקב · {queries} מזהי GraphQL במטמון",
    ...
    "One snippet per line. Reusable replies / templates insert from the composer toolbar.": "קטע אחד בכל שורה. תגובות ותבניות לשימוש חוזר שניתן להוסיף מסרגל הכלים של העורך.",
    ...
    "{count} entries · latest {kind} of {latestCount} @ {at}": "{count} רשומות · האחרון {kind}, {latestCount} ב־{at}",
    ...
    "{total} items · queued {queued} · approved {approved} · skipped {skipped}": "{total} פריטים · בתור {queued} · אושרו {approved} · דולגו {skipped}",
    ...
    "Saving...": "שומר...",
    "Fix invalid values before saving.": "יש לתקן ערכים לא תקינים לפני השמירה.",
    ...
    "Indexed: +{added} new · skipped {skipped} · errors {errors} · total {total}{trimmed}.": "אינדוקס: חדש +{added} · דולגו {skipped} · שגיאות {errors} · סה״כ {total}{trimmed}.",
    ...
    "Exported {records} records across {files} ZIPs → {filename}": "יוצאו {records} רשומות ל־{files} קובצי ZIP → {filename}",
    "Exported {records} record → {filename}": "יוצאה רשומה {records} → {filename}",
    "Exported {records} records → {filename}": "יוצאו {records} רשומות → {filename}",
    ...
    "Copied {records} records to clipboard.": "{records} רשומות הועתקו ללוח.",
    "Exported {records} records to {target}.": "יוצאו {records} רשומות אל {target}.",
    ...
    "gid {gid} · {status}": "מזהה {gid} · {status}",
    "{count} entries": "{count} רשומות",
    "{posts} posts · {likes} likes · {messages} direct messages (kept out of public search) · {media} media refs · {followers} followers · {following} following · {lists} lists": "{posts} פוסטים · {likes} לייקים · {messages} הודעות ישירות (מחוץ לחיפוש הציבורי) · {media} הפניות מדיה · {followers} עוקבים · {following} במעקב · {lists} רשימות",
    "{status} · {filename} · {records} records · {files} files · {warnings} warnings": "{status} · {filename} · {records} רשומות · {files} קבצים · {warnings} אזהרות",
    "{saved} saved · {due} due · {tags} tags · {folders} folders": "{saved} נשמרו · {due} לתזכורת · {tags} תגיות · {folders} תיקיות",
    "{status} · {records} records · {surface}": "{status} · {records} רשומות · {surface}",
    ...
    "Retry {filename}.": "נסה שוב את {filename}.",
    ...
    "Resume archive import": "חידוש ייבוא ארכיון",
    "Cancel archive import": "ביטול ייבוא ארכיון",
    ...
    "Cancel export job": "ביטול משימת ייצוא",
    ...
    "Aviary archive": "ארכיון Aviary",
    "Local archive viewer — remote references are never fetched automatically.": "מציג ארכיון מקומי — הפניות מרוחקות לעולם לא נטענות אוטומטית.",
    "Search records": "חיפוש רשומות",
    "Media status": "מצב מדיה",
    "All media": "כל המדיה",
    "Captured bytes": "בתים שנלכדו",
    "Remote reference": "הפניה מרוחקת",
    "Missing": "חסר",
    "Sort": "מיון",
    "Newest first": "החדשות תחילה",
    "Oldest first": "הישנות תחילה",
    "Handle": "מזהה",
    "Thread view": "תצוגת שרשורים",
    "records": "רשומות",
    "shown": "מוצגות",
    "No matching records.": "אין רשומות תואמות.",
    "source": "מקור",
    "bytes": "בתים",
    "SHA-256": "SHA-256",
    "Open source URL": "פתיחת כתובת המקור",
    "posts": "פוסטים",
...
export const PANEL_STRINGS: string[] = [
  ...
  "Hide Grok surfaces",
  "Remove the Grok drawer, navigation link, image-generation entries, and per-post actions where detected.",
  "Focus mode",
  ...
  "{jobs} jobs tracked · {queries} GraphQL IDs cached",
  "Export status",
  ...
  "Save, search, organize, and revisit posts in a local bookmark library.",
  "Post tools",
  "Writing tools",
  "{count} entries · latest {kind} of {latestCount} @ {at}",
  "Snapshots stored",
  ...
  "Import official X archive",
  "Pick a ZIP exported from x.com. STORE and DEFLATE entries are supported; the source stays local while it is resumable.",
  "Search captured records",
  "Full-text search across the latest export collector run.",
  "@handle, keyword, phrase…",
  "Type to search the records captured by export runs.",
  "Download Markdown report",
  "Audit log + snapshot diff + cleanup preview.",
  "{total} items · queued {queued} · approved {approved} · skipped {skipped}",
  ...
  "Refresh to list in-flight transfers; tap Cancel to abort one.",
  "Refresh",
  "Bluesky crosspost",
  ...
  "Crosspost as thread",
  "Split on blank lines and reply each segment to the previous one.",
  ...
  "Vector similarity over captured records. Embeddings run on demand.",
  ...
  "indexed",
  "{name}: {state} · {config}",
  "{name}: {state} · {count} {indexed}",
  "Integration status",
  "Recent integration errors",
  "Drawn from the audit log; only failed integration calls show up.",
  "Connections",
  "Intelligence",
  "Redacted — saved credentials will be kept.",
  ...
  "Credentials are redacted; the values already saved in this profile will be kept.",
  ...
  "Choose a library backup",
  "Select a JSON backup to inspect its versions, counts, conflicts, and checksum before changing local data.",
  ...
  "Save or revert your changes before leaving this section.",
  "Action failed.",
  "Saving...",
  "Fix invalid values before saving.",
  "Local-only mode on",
  "Local-only mode off",
  "Analytics beacons refused",
  "Analytics beacons allowed",
  "Selector health monitoring on",
  "Selector health monitoring off",
  "Saved warnings cleared.",
  "Could not clear saved warnings.",
  "Ad observations reset.",
  "Could not reset ad observations.",
  "Profile switched. Reloading…",
  "Profile switch failed.",
  "Assigned {moved} stores; {skipped} already existed.",
  "Profile created. Reloading…",
  ...
  "Aria2 reachable.",
  "Aria2 unreachable: {error}",
  "Aria2 connection test failed.",
  "Cancelled {gid}.",
  "Aria2 cancel failed: {error}",
  "Aria2 cancel failed.",
  "Aria2 sweep failed.",
  "Bluesky on",
  "Bluesky off",
  ...
  "Posted {posts} to Bluesky.{url}",
  "Bluesky failed: {error}",
  "Bluesky crosspost failed.",
  "Posted {posts} to Mastodon.{url}",
  "Mastodon failed: {error}",
  ...
  "AI model saved",
  "AI API key saved",
  "AI request budget saved",
  "AI daily budget saved",
  "Semantic search on",
  "Semantic search off",
  "Embedding endpoint saved",
  "Embedding model saved",
  "Embedding API key saved",
  "Embedding request budget saved",
  "Embedding daily budget saved",
  "Auto-embed on",
  "Auto-embed off",
  ...
  "AI and embedding usage cleared",
  "Could not clear AI and embedding usage.",
  "Preferences reset. Ad-free mode is on.",
  "Could not reset settings.",
  "Settings exported.",
  "Could not export settings.",
  "Settings imported. {warning}",
  "Import failed: {errors}",
  "Could not import settings.",
  "Library backup downloaded: {filename} ({collections} collections, {bytes}).",
  "Could not export full library backup.",
  "Reading library backup…",
  "Backup loaded: {collections} collections, {conflicts} changes.",
  "Could not read library backup.",
  "Cancelling restore…",
  "Dry-run complete. No local data changed.",
  "Dry-run failed: {errors}",
  "Could not dry-run library restore.",
  "Library backup restored ({collections} collections). Reloading…",
  "Restore cancelled; local data was rolled back.",
  "Restore cancelled.",
  "Restore failed: {errors}",
  "Could not restore library backup.",
  "Action log on",
  "Action log off",
  "Audit log cleared",
  "Could not clear audit log.",
  "Captured {count} followers for @{handle}.",
  "No UserCell rows found.",
  "Snapshot failed.",
  "Captured {count} following for @{handle}.",
  "Snapshots cleared",
  "Could not clear snapshots.",
  "Archive import paused.",
  "Archive import resumed.",
  "Archive import cancelled.",
  "Archive import retry started.",
  ...
  "Enqueued {added} items ({protected} protected skipped).",
  ...
  "Bookmark removed.",
  "Bookmark was already removed.",
  "Could not remove bookmark.",
  "Bookmarks cleared.",
  "Could not clear bookmarks.",
  "AI button on",
  "AI button off",
  "Unshorten on",
  "Unshorten off",
  ...
  "Exported {records} records across {files} ZIPs → {filename}",
  "Exported {records} record → {filename}",
  "Exported {records} records → {filename}",
  "Export failed. See diagnostics.",
  "Diagnostics copied to clipboard.",
  "Could not copy diagnostics.",
  "Building WARC archive…",
  "WARC downloaded ({records} records).",
  "WARC export failed.",
  "Copied {records} records to clipboard.",
  "Exported {records} records to {target}.",
  ...
  "Concurrent download limit saved",
  "Download pacing saved",
  "History cleared",
  "Could not clear history.",
  "Downloading media from this view…",
  "Batch download failed.",
  "No failed media jobs to retry.",
  "Preset applied: {preset} ({changes})",
  "Preset already applied: {preset}",
  ...
  "Count preference saved",
  "Tab title badge hidden",
  "Tab title badge shown",
  "Absolute timestamps on",
  "Absolute timestamps off",
  "Aviary tab icon on",
  "X tab icon restored",
  "Row borders hidden",
  ...
  "Navigation visibility saved",
  "Offscreen video paused",
  "Offscreen video left playing",
  "Video keeps playing",
  "Video pauses with the tab",
  "Video looping on",
  "Video looping off",
  "Playlist pinning on",
  "Playlist pinning off",
  "Filters enabled",
  "Filters disabled",
  "Seen-post dimming on",
  "Seen-post dimming off",
  "Seen posts forgotten.",
  "Could not clear seen posts.",
  "Filter rules saved",
  ...
  "Cleared {removed} hidden post.",
  "Cleared {removed} hidden posts.",
  "Could not clear hidden posts.",
  "Nothing matches that search.",
  "Try a shorter word, or pick a section on the left.",
  "This userscript manager does not give Aviary access to the page itself.",
  "This browser did not load Aviary's page script.",
  ...
  "blocked (budget is 0)",
  "No matches (or integration disabled).",
  "Open a profile's followers or following list, then use Capture snapshot to record it.",
  "No captured records match “{query}”.",
  "Search all local collections",
  "Search posts, likes, bookmarks, notes, tags, folders, and snapshots with filters.",
  "Search local library (source:, account:, tag:, from:, to:, has:media)",
  "Use semantic ranking (optional)",
  "Try source:bookmarks, tag:reading, or has:media.",
  "No local collections match this search.",
  "(no text)",
  "Find local bookmarks",
  "Search saved posts by text, handle, tags, folder, or ID.",
  "Search local bookmarks",
  "Nothing saved yet. Use Save locally on any post to keep a copy here.",
  "No local bookmarks match this search.",
  "Notes",
  "Bookmark notes",
  "Remove",
  "Add one below as handle: note. Notes appear beside that account's posts.",
  "Turn Capture on, scroll a timeline, then export. Jobs and their records appear here.",
  "Formerly observed markers are no longer detected: {markers}.",
  ...
  "{status} · {filename} · {records} records · {files} files · {warnings} warnings",
  "{saved} saved · {due} due · {tags} tags · {folders} folders",
  "{status} · {records} records · {surface}",
  "{count} this session",
  ...
  "Clear the bounded local marker history and its drift warning. No post text, handles, URLs, or response bodies are stored here.",
  "Pause {filename}.",
  "Resume {filename}.",
  "Cancel {filename}.",
  "Retry {filename}.",
  ...
  "Archive import",
  "Pause archive import",
  "Resume archive import",
  "Cancel archive import",
  "Retry archive import",
  "Local bookmarks",
  ...
  "Review external AI request",
  "Nothing is sent until you choose Send request.",
  "unlimited",
  "Aviary stores usage counters only; the provider's retention follows its policy.",
  "Budget blocked this request.",
  "Send request",
  "Translate",
  ...
  "Aviary is on",
  "Two things are enabled from the start. Everything else stays off until you turn it on.",
  "Sponsored posts, promoted trends and pre-rolls are hidden.",
  "Photos and videos get a save control that only acts when you click it.",
  "Open Aviary from the last row of X's left navigation to change any of it.",
  "Got it",
  "Hide trends, row borders and engagement counts, dim premium posts, strip t.co, dense + dim theme.",
  "Media Archivist",
  "Original-quality downloads, deterministic filenames, dedup history, stacked media.",
  "Creator",
  ...
  "Outside your reading hours",
  "Aviary is covering the timeline until your next window. Nothing is blocked and nothing left this device.",
  "Let me through for five minutes",
  "Bookmark failed",
  "Save locally",
  "Remove local bookmark",
  "Note",
  "Tag",
  "Download access was not granted. Open Aviary Options to enable browser downloads.",
  "Media download failed. Try the on-post button again.",
  "Right-click an image or video first, then choose Aviary download.",
  "Download",
  ...
  "Aviary ships with the narrowest permission set that still works. Everything below is optional, granted only by you, and revocable from this page at any time. Nothing on this page sends data anywhere.",
  "Permission health",
  "granted",
  "optional",
  ...
  "Save media to disk",
  "checking…",
  "Lets the Save and Thumb buttons write files through the browser's download manager, with your filename template and duplicate history. Without it the browser opens media in a tab instead of saving it.",
  "Grant download access",
  "Revoke",
  "Read media hosts directly",
  "Adds the media hosts so large files can be fetched without a page round-trip. Optional — media buttons work without it.",
  "Grant media hosts",
  "Settings, filters, notes and archives live in the Control Center on x.com. This page only manages browser permissions.",
  "This browser did not expose the permissions API.",
  "Request dismissed — nothing changed.",
  "Revoked.",
  "Nothing to revoke.",
  "not granted",
  "Granted. Media saves through the browser now.",
  "Granted. Aviary can read full-size media directly for exports now.",
  "Aviary archive",
  "Local archive viewer — remote references are never fetched automatically.",
  "Search records",
  "Media status",
  "All media",
  "Captured bytes",
  ...
  "Best video quality on",
  "Video quality left to X",
  ...
  "Everything reset. X is untouched again.",
  ...
  "Photos and videos",
  "Default (X decides)",
  "Reveal media X has hidden",
  "Blur every photo and video",
  "Hide every photo and video",
  "Photo and video display saved",
  "Sensitive content",
  "Default (X choice)",
  "Always reveal",
  "Blur until hovered",
