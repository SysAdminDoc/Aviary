...
![Version](https://img.shields.io/badge/version-1.52.2-2f81f7) [![License](https://img.shields.io/badge/license-MIT-3fb950)](LICENSE) ![Platform](https://img.shields.io/badge/platform-Chrome%20%7C%20Firefox%20%7C%20userscript-8b5cf6) ![Runtime dependencies](https://img.shields.io/badge/runtime%20dependencies-0-0ea5e9)
...
[Download v1.52.2](https://github.com/SysAdminDoc/Aviary/releases/tag/v1.52.2) · [Installation guide](docs/INSTALL.md) · [Feature reference](docs/FEATURES.md) · [Privacy](docs/PRIVACY.md)

![Aviary's Quick setup page with four common tasks and six ready-made setups](docs/marketing/presets.png)

*Captured from the built v1.52.2 extension in an isolated browser. The screenshot content is
...
The compact `aviary-source-v1.52.2.zip` includes code and runtime icons for a clean build;
...
Aviary 1.52.2 registers 34 feature modules, draws 15 Control Center destinations, and watches 21 selector surfaces on X.
