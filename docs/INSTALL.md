...
Start with the [v1.54.0 release downloads](https://github.com/SysAdminDoc/Aviary/releases/tag/v1.54.0).
...
1. Download [the Chromium ZIP](https://github.com/SysAdminDoc/Aviary/releases/download/v1.54.0/extension-chrome-v1.54.0.zip)
...
npm run build
sha256sum dist/aviary-source-v1.54.0.zip
```
...
Download and extract [the Firefox ZIP](https://github.com/SysAdminDoc/Aviary/releases/download/v1.54.0/extension-firefox-v1.54.0.zip), then:
