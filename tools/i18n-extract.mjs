...
function stubs(variant) {
  ...
  getAccountCleanupStatus: () => ({
    ...
    run: ${v ? `{
      ...
      settings: {
        mode: "preview",
        categories: { bookmarks: true, likes: true, reposts: true, replies: true, posts: true },
        pacing: "careful",
        maxActions: 0
      },
      stats: Object.fromEntries(["bookmarks", "likes", "reposts", "replies", "posts"].map((category) => [category, { completed: 0, previewed: 1, failed: 0, skipped: 0 }])),
