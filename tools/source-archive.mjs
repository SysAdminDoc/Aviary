...
export const EXCLUDED_SOURCE_PATHS = [
  ...
  "aviary-downloads/",
  // Original artwork and split historical snapshots remain in the repository, not in the
  // compact build-input ZIP. Including a snapshot here would recursively package old dist/.
  "assets/concepts/"
];
