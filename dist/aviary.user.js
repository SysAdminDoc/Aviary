...
`;
  ...
  var PANEL_CATALOG = {
    es: {
      ...
      "Hiding off on every route": "Ocultaci\xF3n desactivada en todas las rutas",
    ...
    pt: {
      ...
      "Hidden posts revealed": "Publica\xE7\xF5es ocultas reveladas",
      "Hide buttons on": "Bot\xF5es de ocultar ativados",
      "Hide buttons off": "Bot\xF5es de ocultar desativados",
      "Hiding off on every route": "Oculta\xE7\xE3o desativada em todas as rotas",
      "Nothing left to restore.": "N\xE3o h\xE1 nada para restaurar.",
    ...
    fr: {
      ...
      "Aria2 handoff on": "Transfert vers Aria2 activ\xE9",
      ...
      "Mastodon on": "Mastodon activ\xE9",
      "Mastodon off": "Mastodon d\xE9sactiv\xE9",
      ...
      "Hidden posts revealed": "Posts masqu\xE9s r\xE9affich\xE9s",
      "Hide buttons on": "Boutons Masquer activ\xE9s",
      "Hide buttons off": "Boutons Masquer d\xE9sactiv\xE9s",
      "Hiding off on every route": "Masquage d\xE9sactiv\xE9 sur toutes les routes",
      "Nothing left to restore.": "Plus rien \xE0 restaurer.",
    ...
    de: {
      ...
      "Aria2 handoff on": "Aria2-\xDCbergabe an",
      ...
      "Hidden posts revealed": "Ausgeblendete Beitr\xE4ge eingeblendet",
      "Hide buttons on": "Ausblenden-Schaltfl\xE4chen an",
      "Hide buttons off": "Ausblenden-Schaltfl\xE4chen aus",
...
`;
  ...
  var PROCESSED_ATTR5 = "data-av-perf-video";
  var PAUSED_ATTR = "data-av-perf-paused";
  var OffscreenVideoPauser = class {
    #observer = null;
    ...
    start(view) {
      ...
      this.#observer = new Observer((entries) => {
        for (const entry of entries) {
          this.#handle(entry.target, entry.isIntersecting);
        }
      });
      return true;
    }
    scan(root) {
      ...
      for (const video of videos) {
        ...
        video.setAttribute(PROCESSED_ATTR5, "1");
        const onPause = () => {
    ...
    stop() {
      ...
      for (const video of this.#tracked) {
        ...
        video.removeAttribute(PROCESSED_ATTR5);
        video.removeAttribute(PAUSED_ATTR);
      }
      this.#tracked.clear();
      this.#resumable.clear();
    }
    #handle(video, visible) {
      if (!visible) {
  ...
  var pauser = new OffscreenVideoPauser();
  var available = true;
  var pauseOffscreenVideoFeature = {
